 ...
 */
class Vat extends SoapClientBase
{
    /**
    ...
    /**
     * Method to call the operation originally named vatValidate
     ...
     * - documentation: Check if a VAT number is valid
     * @uses SoapClientBase::getSoapClient()
     * @uses SoapClientBase::setResult()
     * @uses SoapClientBase::getResult()
     * @uses SoapClientBase::saveLastError()
     * @param \Webservices\StructType\VatValidateRequestType $parameters
     * @return \Webservices\StructType\VatValidateResponseType|bool
     */
    public function vatValidate(\Webservices\StructType\VatValidateRequestType $parameters)
    {
        try {
            $this->setResult(self::getSoapClient()->vatValidate($parameters));
    ...
    /**
     * Method to call the operation originally named vatViesProxyCheckVat
     * Meta informations extracted from the WSDL
     * - SOAPHeaderNames: HeaderLogin, HeaderAuthenticate
     * - SOAPHeaderNamespaces: http://www.webservices.nl/soap/, http://www.webservices.nl/soap/
     * - SOAPHeaderTypes: \Webservices\StructType\HeaderLoginType, \Webservices\StructType\HeaderAuthenticateType
     ...
     * @uses SoapClientBase::getResult()
     * @uses SoapClientBase::saveLastError()
     * @param \Webservices\StructType\VatViesProxyCheckVatRequestType $parameters
     * @return \Webservices\StructType\VatViesProxyCheckVatResponseType|bool
     */
    public function vatViesProxyCheckVat(\Webservices\StructType\VatViesProxyCheckVatRequestType $parameters)
    {
        try {
            $this->setResult(self::getSoapClient()->vatViesProxyCheckVat($parameters));
            return $this->getResult();
        } catch (\SoapFault $soapFault) {
            $this->saveLastError(__METHOD__, $soapFault);
            return false;
     ...
     * @return \Webservices\StructType\VatValidateResponseType|\Webservices\StructType\VatViesProxyCheckVatResponseType
     */
