...
class Create extends SoapClientBase
{
    ...
    /**
     * Method to call the operation originally named createTestUser
     ...
     * - documentation: Create a WebservicesNl test user
     * @uses SoapClientBase::getSoapClient()
     * @uses SoapClientBase::setResult()
     * @uses SoapClientBase::getResult()
     * @uses SoapClientBase::saveLastError()
     * @param \Webservices\StructType\CreateTestUserRequestType $parameters
     * @return \Webservices\StructType\CreateTestUserResponseType|bool
     */
    public function createTestUser(\Webservices\StructType\CreateTestUserRequestType $parameters)
    {
        try {
            $this->setResult(self::getSoapClient()->createTestUser($parameters));
