...
class Login extends SoapClientBase
{
     ...
     * - documentation: Logs the user in using username and password, returns a reactid for authentication in further requests
     * @uses SoapClientBase::getSoapClient()
     * @uses SoapClientBase::setResult()
     * @uses SoapClientBase::getResult()
     * @uses SoapClientBase::saveLastError()
     * @param \Webservices\StructType\LoginRequestType $parameters
     * @return \Webservices\StructType\LoginResponseType|bool
     */
    public function login(\Webservices\StructType\LoginRequestType $parameters)
    {
        try {
