...
/**
 * This class stands for Nbwo ServiceType
 * @subpackage Services
 * @author JCID <info@jcid.nl>
 */
class Nbwo extends SoapClientBase
{
    /**
    ...
    /**
     * Method to call the operation originally named nbwoEstimateValue
     ...
     * - documentation: Returns a value estimate for the real estate at the specified address
     * @uses SoapClientBase::getSoapClient()
     * @uses SoapClientBase::setResult()
     * @uses SoapClientBase::getResult()
     * @uses SoapClientBase::saveLastError()
     * @param \Webservices\StructType\NbwoEstimateValueRequestType $parameters
     * @return \Webservices\StructType\NbwoEstimateValueResponseType|bool
     */
    public function nbwoEstimateValue(\Webservices\StructType\NbwoEstimateValueRequestType $parameters)
    {
        try {
            $this->setResult(self::getSoapClient()->nbwoEstimateValue($parameters));
