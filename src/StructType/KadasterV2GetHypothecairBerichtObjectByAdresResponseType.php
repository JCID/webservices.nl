...
/**
 * This class stands for kadasterV2GetHypothecairBerichtObjectByAdresResponseType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterV2GetHypothecairBerichtObjectByAdresResponseType extends AbstractStructBase
{
    /**
     * The resultaat
    ...
    public $resultaat;
    /**
     * Constructor method for kadasterV2GetHypothecairBerichtObjectByAdresResponseType
     * @uses KadasterV2GetHypothecairBerichtObjectByAdresResponseType::setResultaat()
     ...
     * Set resultaat value
     * @param \Webservices\StructType\KadasterV2HypothecairBerichtObjectResponse $resultaat
     * @return \Webservices\StructType\KadasterV2GetHypothecairBerichtObjectByAdresResponseType
     */
