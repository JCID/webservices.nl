...
/**
 * This class stands for CarVWEVersionPrice StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class CarVWEVersionPrice extends AbstractStructBase
{
    /**
     * The brand_atl
    ...
    /**
     * The version
     * @var \Webservices\StructType\CarVWEVersionPriceReference
     */
    public $version;
    /**
     * The prices
    ...
    public $prices;
    /**
     * Constructor method for CarVWEVersionPrice
     * @uses CarVWEVersionPrice::setBrand_atl()
     * @uses CarVWEVersionPrice::setModel_atl()
     * @uses CarVWEVersionPrice::setShort_type()
     * @uses CarVWEVersionPrice::setFuel_type()
     * @uses CarVWEVersionPrice::setCylinder_capacity()
     * @uses CarVWEVersionPrice::setSeats()
     * @uses CarVWEVersionPrice::setPower()
     * @uses CarVWEVersionPrice::setEnergy_label()
     * @uses CarVWEVersionPrice::setEmission_code()
     * @uses CarVWEVersionPrice::setDoors()
     * @uses CarVWEVersionPrice::setGear()
     * @uses CarVWEVersionPrice::setTop_speed()
     * @uses CarVWEVersionPrice::setFolder_weight()
     * @uses CarVWEVersionPrice::setTrain_weight()
     * @uses CarVWEVersionPrice::setLayout()
     * @uses CarVWEVersionPrice::setDesign()
     * @uses CarVWEVersionPrice::setAcceleration()
     * @uses CarVWEVersionPrice::setSportivity()
     * @uses CarVWEVersionPrice::setVersion()
     * @uses CarVWEVersionPrice::setPrices()
     ...
     * @param \Webservices\StructType\CarVWEVersionPriceReference $version
     * @param \Webservices\StructType\CarVWEPrices $prices
     */
    public function __construct($brand_atl = null, $model_atl = null, $short_type = null, $fuel_type = null, $cylinder_capacity = null, $seats = null, $power = null, $energy_label = null, $emission_code = null, $doors = null, $gear = null, $top_speed = null, $folder_weight = null, $train_weight = null, $layout = null, $design = null, $acceleration = null, $sportivity = null, \Webservices\StructType\CarVWEVersionPriceReference $version = null, \Webservices\StructType\CarVWEPrices $prices = null)
    {
        $this
     ...
     * Set brand_atl value
     * @param string $brand_atl
     * @return \Webservices\StructType\CarVWEVersionPrice
     */
    ...
    public function setDesign($design = null)
    {
        ...
        if (!is_null($design) && !is_string($design)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a string, "%s" given', gettype($design)), __LINE__);
        }
        $this->design = $design;
        return $this;
    }
    ...
    /**
     * Get version value
     * @return \Webservices\StructType\CarVWEVersionPriceReference|null
     */
     ...
     * @return \Webservices\StructType\CarVWEVersionPrice
     */
    public function setVersion(\Webservices\StructType\CarVWEVersionPriceReference $version = null)
    {
