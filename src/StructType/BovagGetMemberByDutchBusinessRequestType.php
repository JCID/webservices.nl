...
/**
 * This class stands for bovagGetMemberByDutchBusinessRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BovagGetMemberByDutchBusinessRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for bovagGetMemberByDutchBusinessRequestType
     * @uses BovagGetMemberByDutchBusinessRequestType::setDossier_number()
     * @uses BovagGetMemberByDutchBusinessRequestType::setEstablishment_number()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\BovagGetMemberByDutchBusinessRequestType
     */
