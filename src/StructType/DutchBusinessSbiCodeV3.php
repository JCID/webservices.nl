...
/**
 * This class stands for DutchBusinessSbiCodeV3 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessSbiCodeV3 extends AbstractStructBase
{
    /**
     * The sbi_code
    ...
    public $description;
    /**
     * Constructor method for DutchBusinessSbiCodeV3
     * @uses DutchBusinessSbiCodeV3::setSbi_code()
     * @uses DutchBusinessSbiCodeV3::setDescription()
     ...
     * Set sbi_code value
     * @param string $sbi_code
     * @return \Webservices\StructType\DutchBusinessSbiCodeV3
     */
