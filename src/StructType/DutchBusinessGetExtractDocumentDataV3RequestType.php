...
/**
 * This class stands for dutchBusinessGetExtractDocumentDataV3RequestType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessGetExtractDocumentDataV3RequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for dutchBusinessGetExtractDocumentDataV3RequestType
     * @uses DutchBusinessGetExtractDocumentDataV3RequestType::setDossier_number()
     * @uses DutchBusinessGetExtractDocumentDataV3RequestType::setInclude_source()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessGetExtractDocumentDataV3RequestType
     */
