...
/**
 * This class stands for dutchBusinessSearchEstablishmentsRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessSearchEstablishmentsRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    public $page;
    /**
     * Constructor method for dutchBusinessSearchEstablishmentsRequestType
     * @uses DutchBusinessSearchEstablishmentsRequestType::setDossier_number()
     * @uses DutchBusinessSearchEstablishmentsRequestType::setEstablishment_number()
     * @uses DutchBusinessSearchEstablishmentsRequestType::setRsin_number()
     * @uses DutchBusinessSearchEstablishmentsRequestType::setPage()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessSearchEstablishmentsRequestType
     */
