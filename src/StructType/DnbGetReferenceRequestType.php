...
/**
 * This class stands for dnbGetReferenceRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DnbGetReferenceRequestType extends AbstractStructBase
{
    /**
     * The company_id
     * @var string
    ...
    /**
     * Constructor method for dnbGetReferenceRequestType
     * @uses DnbGetReferenceRequestType::setCompany_id()
     * @uses DnbGetReferenceRequestType::setCompany_id_type()
     ...
     * @param string $company_id
     * @return \Webservices\StructType\DnbGetReferenceRequestType
     */
