...
/**
 * This class stands for kadasterKadastraleKaartPerceelV2RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterKadastraleKaartPerceelV2RequestType extends AbstractStructBase
{
    /**
     * The gemeentecode
     * @var string
    ...
    public $schaal;
    /**
     * Constructor method for kadasterKadastraleKaartPerceelV2RequestType
     * @uses KadasterKadastraleKaartPerceelV2RequestType::setGemeentecode()
     * @uses KadasterKadastraleKaartPerceelV2RequestType::setGemeentenaam()
     * @uses KadasterKadastraleKaartPerceelV2RequestType::setSectie()
     * @uses KadasterKadastraleKaartPerceelV2RequestType::setPerceelnummer()
     * @uses KadasterKadastraleKaartPerceelV2RequestType::setRelatiecode()
     * @uses KadasterKadastraleKaartPerceelV2RequestType::setVolgnummer()
     * @uses KadasterKadastraleKaartPerceelV2RequestType::setFormat()
     * @uses KadasterKadastraleKaartPerceelV2RequestType::setSchaal()
     ...
     * @param string $gemeentecode
     * @return \Webservices\StructType\KadasterKadastraleKaartPerceelV2RequestType
     */
