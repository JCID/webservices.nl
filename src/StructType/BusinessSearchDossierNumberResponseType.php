...
/**
 * This class stands for businessSearchDossierNumberResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BusinessSearchDossierNumberResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for businessSearchDossierNumberResponseType
     * @uses BusinessSearchDossierNumberResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\BusinessReferencePagedResult $out
     * @return \Webservices\StructType\BusinessSearchDossierNumberResponseType
     */
