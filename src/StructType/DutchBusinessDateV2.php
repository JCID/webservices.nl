...
/**
 * This class stands for DutchBusinessDateV2 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessDateV2 extends AbstractStructBase
{
    /**
     * The year
    ...
    public $day;
    /**
     * Constructor method for DutchBusinessDateV2
     * @uses DutchBusinessDateV2::setYear()
     * @uses DutchBusinessDateV2::setMonth()
     * @uses DutchBusinessDateV2::setDay()
     * @param int $year
     * @param int $month
     * @param int $day
     */
     ...
     * Set year value
     * @param int $year
     * @return \Webservices\StructType\DutchBusinessDateV2
     */
