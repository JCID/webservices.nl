...
/**
 * This class stands for dnbEnterpriseManagementRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DnbEnterpriseManagementRequestType extends AbstractStructBase
{
    /**
     * The company_id
     * @var string
    ...
    /**
     * Constructor method for dnbEnterpriseManagementRequestType
     * @uses DnbEnterpriseManagementRequestType::setCompany_id()
     * @uses DnbEnterpriseManagementRequestType::setCompany_id_type()
     ...
     * @param string $company_id
     * @return \Webservices\StructType\DnbEnterpriseManagementRequestType
     */
