...
/**
 * This class stands for businessGetDossierSBIRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BusinessGetDossierSBIRequestType extends AbstractStructBase
{
    /**
     * The dossierno
     * @var string
    ...
    public $subdossierno;
    /**
     * Constructor method for businessGetDossierSBIRequestType
     * @uses BusinessGetDossierSBIRequestType::setDossierno()
     * @uses BusinessGetDossierSBIRequestType::setSubdossierno()
     ...
     * Set dossierno value
     * @param string $dossierno
     * @return \Webservices\StructType\BusinessGetDossierSBIRequestType
     */
