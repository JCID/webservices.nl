...
/**
 * This class stands for kadasterEigendomsBerichtDocumentPerceelRequestType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterEigendomsBerichtDocumentPerceelRequestType extends AbstractStructBase
{
    /**
     * The gemeentecode
     * @var string
    ...
    public $format;
    /**
     * Constructor method for kadasterEigendomsBerichtDocumentPerceelRequestType
     * @uses KadasterEigendomsBerichtDocumentPerceelRequestType::setGemeentecode()
     * @uses KadasterEigendomsBerichtDocumentPerceelRequestType::setGemeentenaam()
     * @uses KadasterEigendomsBerichtDocumentPerceelRequestType::setSectie()
     * @uses KadasterEigendomsBerichtDocumentPerceelRequestType::setPerceelnummer()
     * @uses KadasterEigendomsBerichtDocumentPerceelRequestType::setRelatiecode()
     * @uses KadasterEigendomsBerichtDocumentPerceelRequestType::setVolgnummer()
     * @uses KadasterEigendomsBerichtDocumentPerceelRequestType::setFormat()
     ...
     * @param string $gemeentecode
     * @return \Webservices\StructType\KadasterEigendomsBerichtDocumentPerceelRequestType
     */
