...
/**
 * This class stands for PCReeks StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class PCReeks extends AbstractStructBase
{
    /**
     * The reeksid
     * @var int
    ...
    /**
     * Constructor method for PCReeks
     * @uses PCReeks::setReeksid()
     * @uses PCReeks::setHuisnr_van()
     * @uses PCReeks::setHuisnr_tm()
     * @uses PCReeks::setWijkcode()
     * @uses PCReeks::setLettercombinatie()
     * @uses PCReeks::setReeksindicatie()
     * @uses PCReeks::setStraatid()
     * @uses PCReeks::setStraatnaam()
     * @uses PCReeks::setStraatnaam_nen()
     * @uses PCReeks::setStraatnaam_ptt()
     * @uses PCReeks::setStraatnaam_extract()
     * @uses PCReeks::setPlaatsid()
     * @uses PCReeks::setPlaatsnaam()
     * @uses PCReeks::setPlaatsnaam_ptt()
     * @uses PCReeks::setPlaatsnaam_extract()
     * @uses PCReeks::setGemeenteid()
     * @uses PCReeks::setGemeentenaam()
     * @uses PCReeks::setGemeentecode()
     * @uses PCReeks::setCebucocode()
     * @uses PCReeks::setProvinciecode()
     * @uses PCReeks::setProvincienaam()
     * @param int $reeksid
     ...
     * Set reeksid value
     * @param int $reeksid
     * @return \Webservices\StructType\PCReeks
     */
