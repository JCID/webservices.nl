 ...
 * kadasterV2GetUittrekselKadastraleKaartByObjectIdResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterV2GetUittrekselKadastraleKaartByObjectIdResponseType extends AbstractStructBase
{
    /**
     * The resultaat
     ...
     * kadasterV2GetUittrekselKadastraleKaartByObjectIdResponseType
     * @uses KadasterV2GetUittrekselKadastraleKaartByObjectIdResponseType::setResultaat()
     ...
     * Set resultaat value
     * @param \Webservices\StructType\KadasterV2UittrekselKadastraleKaartResponse $resultaat
     * @return \Webservices\StructType\KadasterV2GetUittrekselKadastraleKaartByObjectIdResponseType
     */
