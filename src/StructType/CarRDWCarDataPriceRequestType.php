...
/**
 * This class stands for carRDWCarDataPriceRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class CarRDWCarDataPriceRequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    /**
     * Constructor method for carRDWCarDataPriceRequestType
     * @uses CarRDWCarDataPriceRequestType::setLicense_plate()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\CarRDWCarDataPriceRequestType
     */
