...
/**
 * This class stands for geoLocationRDToLatLonRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class GeoLocationRDToLatLonRequestType extends AbstractStructBase
{
    /**
     * The x
     * @var int
    ...
    public $y;
    /**
     * Constructor method for geoLocationRDToLatLonRequestType
     * @uses GeoLocationRDToLatLonRequestType::setX()
     * @uses GeoLocationRDToLatLonRequestType::setY()
     * @param int $x
     * @param int $y
     */
     ...
     * Set x value
     * @param int $x
     * @return \Webservices\StructType\GeoLocationRDToLatLonRequestType
     */
