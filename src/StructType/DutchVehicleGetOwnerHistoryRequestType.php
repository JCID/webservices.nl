...
/**
 * This class stands for dutchVehicleGetOwnerHistoryRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchVehicleGetOwnerHistoryRequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    /**
     * Constructor method for dutchVehicleGetOwnerHistoryRequestType
     * @uses DutchVehicleGetOwnerHistoryRequestType::setLicense_plate()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\DutchVehicleGetOwnerHistoryRequestType
     */
