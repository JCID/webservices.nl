...
/**
 * This class stands for DutchVehicle StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchVehicle extends AbstractStructBase
{
    /**
     * The basic_data
    ...
    public $recall;
    /**
     * Constructor method for DutchVehicle
     * @uses DutchVehicle::setBasic_data()
     * @uses DutchVehicle::setStatus()
     * @uses DutchVehicle::setRegistration()
     * @uses DutchVehicle::setDetails()
     * @uses DutchVehicle::setTax()
     * @uses DutchVehicle::setTechnical_weight()
     * @uses DutchVehicle::setEngine()
     * @uses DutchVehicle::setEnvironmental_impact()
     * @uses DutchVehicle::setAxle_information()
     * @uses DutchVehicle::setType_approval()
     * @uses DutchVehicle::setBody_approval()
     * @uses DutchVehicle::setRemark()
     * @uses DutchVehicle::setRecall()
     ...
     * @param \Webservices\StructType\DutchVehicleData $basic_data
     * @return \Webservices\StructType\DutchVehicle
     */
