...
/**
 * This class stands for dutchBusinessSearchDossierNumberResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessSearchDossierNumberResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for dutchBusinessSearchDossierNumberResponseType
     * @uses DutchBusinessSearchDossierNumberResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\DutchBusinessReferencePagedResult $out
     * @return \Webservices\StructType\DutchBusinessSearchDossierNumberResponseType
     */
