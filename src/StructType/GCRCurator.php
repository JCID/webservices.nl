...
/**
 * This class stands for GCRCurator StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class GCRCurator extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GCRCurator
     * @uses GCRCurator::setGraydon_person_id()
     * @uses GCRCurator::setDate_when_active_in_job_title()
     ...
     * @param int $graydon_person_id
     * @return \Webservices\StructType\GCRCurator
     */
