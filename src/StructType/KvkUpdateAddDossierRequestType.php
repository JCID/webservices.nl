...
/**
 * This class stands for kvkUpdateAddDossierRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KvkUpdateAddDossierRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for kvkUpdateAddDossierRequestType
     * @uses KvkUpdateAddDossierRequestType::setDossier_number()
     * @uses KvkUpdateAddDossierRequestType::setEstablishment_number()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\KvkUpdateAddDossierRequestType
     */
