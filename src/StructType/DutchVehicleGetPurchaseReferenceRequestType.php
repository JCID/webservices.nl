...
/**
 * This class stands for dutchVehicleGetPurchaseReferenceRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchVehicleGetPurchaseReferenceRequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    /**
     * Constructor method for dutchVehicleGetPurchaseReferenceRequestType
     * @uses DutchVehicleGetPurchaseReferenceRequestType::setLicense_plate()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\DutchVehicleGetPurchaseReferenceRequestType
     */
