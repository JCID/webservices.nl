...
/**
 * This class stands for dutchBusinessGetLegalExtractDocumentDataV2RequestType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessGetLegalExtractDocumentDataV2RequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for dutchBusinessGetLegalExtractDocumentDataV2RequestType
     * @uses DutchBusinessGetLegalExtractDocumentDataV2RequestType::setDossier_number()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessGetLegalExtractDocumentDataV2RequestType
     */
