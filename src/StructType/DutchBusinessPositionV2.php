...
/**
 * This class stands for DutchBusinessPositionV2 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessPositionV2 extends AbstractStructBase
{
    /**
     * The functionary
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \Webservices\StructType\DutchBusinessPersonV2
     */
    public $functionary;
    /**
     * The organisation
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \Webservices\StructType\DutchBusinessOrganizationReferenceV2
     */
    public $organisation;
    /**
    ...
    public $remarks;
    /**
     * Constructor method for DutchBusinessPositionV2
     * @uses DutchBusinessPositionV2::setFunctionary()
     * @uses DutchBusinessPositionV2::setOrganisation()
     * @uses DutchBusinessPositionV2::setResidential_address()
     * @uses DutchBusinessPositionV2::setCorrespondence_address()
     * @uses DutchBusinessPositionV2::setEstablishment_address()
     * @uses DutchBusinessPositionV2::setLongest_serving()
     * @uses DutchBusinessPositionV2::setFunction_type()
     * @uses DutchBusinessPositionV2::setFunction_description()
     * @uses DutchBusinessPositionV2::setFunction_title()
     * @uses DutchBusinessPositionV2::setFunction_start_date()
     * @uses DutchBusinessPositionV2::setFunction_registration_date()
     * @uses DutchBusinessPositionV2::setFunction_end_date()
     * @uses DutchBusinessPositionV2::setFunction_authorization()
     * @uses DutchBusinessPositionV2::setFunction_authorization_description()
     * @uses DutchBusinessPositionV2::setFunction_authorization_start_date()
     * @uses DutchBusinessPositionV2::setFunction_authorization_signing_power()
     * @uses DutchBusinessPositionV2::setFunction_authorization_end_date()
     * @uses DutchBusinessPositionV2::setAuthorization_description()
     * @uses DutchBusinessPositionV2::setAuthorization_establishment_number()
     * @uses DutchBusinessPositionV2::setAuthorization_start_date()
     * @uses DutchBusinessPositionV2::setAuthorization_end_date()
     * @uses DutchBusinessPositionV2::setAuthorization_constraints()
     * @uses DutchBusinessPositionV2::setInauguration()
     * @uses DutchBusinessPositionV2::setInauguration_function()
     * @uses DutchBusinessPositionV2::setInauguration_duration()
     * @uses DutchBusinessPositionV2::setInauguration_date()
     * @uses DutchBusinessPositionV2::setInauguration_body()
     * @uses DutchBusinessPositionV2::setUnder_receivership()
     * @uses DutchBusinessPositionV2::setRights_against_third_parties()
     * @uses DutchBusinessPositionV2::setRelease_of_covenant()
     * @uses DutchBusinessPositionV2::setDate_since()
     * @uses DutchBusinessPositionV2::setDate_joined()
     * @uses DutchBusinessPositionV2::setRemarks()
     * @param \Webservices\StructType\DutchBusinessPersonV2 $functionary
     * @param \Webservices\StructType\DutchBusinessOrganizationReferenceV2 $organisation
     * @param \Webservices\StructType\DutchBusinessAddressV2 $residential_address
     ...
     * @param \Webservices\StructType\DutchBusinessDateV2 $function_registration_date
     * @param \Webservices\StructType\DutchBusinessDateV2 $function_end_date
     * @param string $function_authorization
     * @param string $function_authorization_description
     * @param \Webservices\StructType\DutchBusinessDateV2 $function_authorization_start_date
     * @param string $function_authorization_signing_power
     * @param \Webservices\StructType\DutchBusinessDateV2 $function_authorization_end_date
     * @param string $authorization_description
     * @param string $authorization_establishment_number
     * @param \Webservices\StructType\DutchBusinessDateV2 $authorization_start_date
     * @param \Webservices\StructType\DutchBusinessDateV2 $authorization_end_date
     ...
     * @param \Webservices\StructType\DutchBusinessDateV2 $inauguration_date
     ...
     * @return \Webservices\StructType\DutchBusinessPersonV2|null
     */
     ...
     * @param \Webservices\StructType\DutchBusinessPersonV2 $functionary
     * @return \Webservices\StructType\DutchBusinessPositionV2
     */
    public function setFunctionary(\Webservices\StructType\DutchBusinessPersonV2 $functionary = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessOrganizationReferenceV2|null
     */
     ...
     * @return \Webservices\StructType\DutchBusinessPositionV2
     */
    public function setOrganisation(\Webservices\StructType\DutchBusinessOrganizationReferenceV2 $organisation = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessPositionV2
     */
    public function setResidential_address(\Webservices\StructType\DutchBusinessAddressV2 $residential_address = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessPositionV2
     */
    public function setFunction_registration_date(\Webservices\StructType\DutchBusinessDateV2 $function_registration_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessPositionV2
     */
    public function setFunction_end_date(\Webservices\StructType\DutchBusinessDateV2 $function_end_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessPositionV2
     */
    public function setFunction_authorization_start_date(\Webservices\StructType\DutchBusinessDateV2 $function_authorization_start_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessPositionV2
     */
    public function setFunction_authorization_end_date(\Webservices\StructType\DutchBusinessDateV2 $function_authorization_end_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessPositionV2
     */
    public function setAuthorization_start_date(\Webservices\StructType\DutchBusinessDateV2 $authorization_start_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessPositionV2
     */
    public function setAuthorization_end_date(\Webservices\StructType\DutchBusinessDateV2 $authorization_end_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessPositionV2
     */
    public function setInauguration_date(\Webservices\StructType\DutchBusinessDateV2 $inauguration_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessPositionV2
     */
    public function setDate_joined(\Webservices\StructType\DutchBusinessDateV2 $date_joined = null)
    {
