...
/**
 * This class stands for KadasterV2OnroerendeZaakFiliatie StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterV2OnroerendeZaakFiliatie extends AbstractStructBase
{
    /**
     * The aard
    ...
    public $betreft_oz;
    /**
     * Constructor method for KadasterV2OnroerendeZaakFiliatie
     * @uses KadasterV2OnroerendeZaakFiliatie::setAard()
     * @uses KadasterV2OnroerendeZaakFiliatie::setOvergangsgrootte()
     * @uses KadasterV2OnroerendeZaakFiliatie::setBetreft_oz()
     * @param string $aard
     ...
     * Set aard value
     * @param string $aard
     * @return \Webservices\StructType\KadasterV2OnroerendeZaakFiliatie
     */
