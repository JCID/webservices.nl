...
/**
 * This class stands for dutchBusinessUpdateGetChangedDossiersRequestType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessUpdateGetChangedDossiersRequestType extends AbstractStructBase
{
    /**
     * The changed_since
     * @var string
    ...
    public $page;
    /**
     * Constructor method for dutchBusinessUpdateGetChangedDossiersRequestType
     * @uses DutchBusinessUpdateGetChangedDossiersRequestType::setChanged_since()
     * @uses DutchBusinessUpdateGetChangedDossiersRequestType::setUpdate_types()
     * @uses DutchBusinessUpdateGetChangedDossiersRequestType::setPage()
     ...
     * @param string $changed_since
     * @return \Webservices\StructType\DutchBusinessUpdateGetChangedDossiersRequestType
     */
