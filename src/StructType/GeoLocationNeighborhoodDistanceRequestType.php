...
/**
 * This class stands for geoLocationNeighborhoodDistanceRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class GeoLocationNeighborhoodDistanceRequestType extends AbstractStructBase
{
    /**
     * The nbcodefrom
     * @var string
    ...
    public $nbcodeto;
    /**
     * Constructor method for geoLocationNeighborhoodDistanceRequestType
     * @uses GeoLocationNeighborhoodDistanceRequestType::setNbcodefrom()
     * @uses GeoLocationNeighborhoodDistanceRequestType::setNbcodeto()
     ...
     * @param string $nbcodefrom
     * @return \Webservices\StructType\GeoLocationNeighborhoodDistanceRequestType
     */
