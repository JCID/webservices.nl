...
/**
 * This class stands for OverzichtPersoon StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class OverzichtPersoon extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for OverzichtPersoon
     * @uses OverzichtPersoon::setId()
     * @uses OverzichtPersoon::setNatuurlijk_persoon()
     * @uses OverzichtPersoon::setNiet_natuurlijk_persoon()
     * @param string $id
     ...
     */
    public function __construct($id = null, \Webservices\StructType\OverzichtNatuurlijkPersoon $natuurlijk_persoon = null, \Webservices\StructType\OverzichtNietNatuurlijkPersoon $niet_natuurlijk_persoon = null)
    {
        $this
            ->setId($id)
     ...
     * Set id value
     * @param string $id
     * @return \Webservices\StructType\OverzichtPersoon
     */
