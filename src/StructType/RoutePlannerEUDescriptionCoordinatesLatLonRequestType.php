...
/**
 * This class stands for routePlannerEUDescriptionCoordinatesLatLonRequestType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class RoutePlannerEUDescriptionCoordinatesLatLonRequestType extends AbstractStructBase
{
    /**
     * The latitudefrom
     * @var float
    ...
    public $language;
    /**
     * Constructor method for routePlannerEUDescriptionCoordinatesLatLonRequestType
     * @uses RoutePlannerEUDescriptionCoordinatesLatLonRequestType::setLatitudefrom()
     * @uses RoutePlannerEUDescriptionCoordinatesLatLonRequestType::setLongitudefrom()
     * @uses RoutePlannerEUDescriptionCoordinatesLatLonRequestType::setLatitudeto()
     * @uses RoutePlannerEUDescriptionCoordinatesLatLonRequestType::setLongitudeto()
     * @uses RoutePlannerEUDescriptionCoordinatesLatLonRequestType::setRoutetype()
     * @uses RoutePlannerEUDescriptionCoordinatesLatLonRequestType::setLanguage()
     ...
     * @param float $latitudefrom
     * @return \Webservices\StructType\RoutePlannerEUDescriptionCoordinatesLatLonRequestType
     */
