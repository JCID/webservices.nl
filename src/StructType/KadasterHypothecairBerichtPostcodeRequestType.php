...
/**
 * This class stands for kadasterHypothecairBerichtPostcodeRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterHypothecairBerichtPostcodeRequestType extends AbstractStructBase
{
    /**
     * The postcode
     * @var string
    ...
    public $format;
    /**
     * Constructor method for kadasterHypothecairBerichtPostcodeRequestType
     * @uses KadasterHypothecairBerichtPostcodeRequestType::setPostcode()
     * @uses KadasterHypothecairBerichtPostcodeRequestType::setHuisnummer()
     * @uses KadasterHypothecairBerichtPostcodeRequestType::setHuisnummer_toevoeging()
     * @uses KadasterHypothecairBerichtPostcodeRequestType::setFormat()
     ...
     * Set postcode value
     * @param string $postcode
     * @return \Webservices\StructType\KadasterHypothecairBerichtPostcodeRequestType
     */
