...
/**
 * This class stands for kadasterV2GetKadastraalBerichtObjectByAdresRequestType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterV2GetKadastraalBerichtObjectByAdresRequestType extends AbstractStructBase
{
    /**
     * The postcode
     * @var string
    ...
    public $huisletter;
    /**
     * Constructor method for kadasterV2GetKadastraalBerichtObjectByAdresRequestType
     * @uses KadasterV2GetKadastraalBerichtObjectByAdresRequestType::setPostcode()
     * @uses KadasterV2GetKadastraalBerichtObjectByAdresRequestType::setHuisnummer()
     * @uses KadasterV2GetKadastraalBerichtObjectByAdresRequestType::setHuisnummer_toevoeging()
     * @uses KadasterV2GetKadastraalBerichtObjectByAdresRequestType::setDocument()
     * @uses KadasterV2GetKadastraalBerichtObjectByAdresRequestType::setHuisletter()
     ...
     * Set postcode value
     * @param string $postcode
     * @return \Webservices\StructType\KadasterV2GetKadastraalBerichtObjectByAdresRequestType
     */
