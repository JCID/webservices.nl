...
/**
 * This class stands for dutchBusinessSearchSelectionRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessSearchSelectionRequestType extends AbstractStructBase
{
    /**
     * The city
     ...
     * @var string
     */
    public $sbi_match_type;
    /**
     * Constructor method for dutchBusinessSearchSelectionRequestType
     * @uses DutchBusinessSearchSelectionRequestType::setCity()
     * @uses DutchBusinessSearchSelectionRequestType::setPostcode()
     * @uses DutchBusinessSearchSelectionRequestType::setSbi()
     * @uses DutchBusinessSearchSelectionRequestType::setPrimary_sbi_only()
     * @uses DutchBusinessSearchSelectionRequestType::setLegal_form()
     * @uses DutchBusinessSearchSelectionRequestType::setEmployees_min()
     * @uses DutchBusinessSearchSelectionRequestType::setEmployees_max()
     * @uses DutchBusinessSearchSelectionRequestType::setEconomically_active()
     * @uses DutchBusinessSearchSelectionRequestType::setFinancial_status()
     * @uses DutchBusinessSearchSelectionRequestType::setChanged_since()
     * @uses DutchBusinessSearchSelectionRequestType::setNew_since()
     * @uses DutchBusinessSearchSelectionRequestType::setPage()
     * @uses DutchBusinessSearchSelectionRequestType::setProvinces()
     * @uses DutchBusinessSearchSelectionRequestType::setSbi_match_type()
     ...
     * @param int $page
     * @param \Webservices\ArrayType\StringArray $provinces
     * @param string $sbi_match_type
     */
    public function __construct(\Webservices\ArrayType\StringArray $city = null, \Webservices\ArrayType\StringArray $postcode = null, \Webservices\ArrayType\StringArray $sbi = null, $primary_sbi_only = null, \Webservices\ArrayType\IntArray $legal_form = null, $employees_min = null, $employees_max = null, $economically_active = null, $financial_status = null, $changed_since = null, $new_since = null, $page = null, \Webservices\ArrayType\StringArray $provinces = null, $sbi_match_type = null)
    {
        $this
            ->setCity($city)
            ...
            ->setSbi_match_type($sbi_match_type);
    }
    /**
     * Get city value
     ...
     * Set city value
     * @param \Webservices\ArrayType\StringArray $city
     * @return \Webservices\StructType\DutchBusinessSearchSelectionRequestType
     */
     ...
     * @return \Webservices\StructType\DutchBusinessSearchSelectionRequestType
     */
    public function setProvinces(\Webservices\ArrayType\StringArray $provinces = null)
    {
        $this->provinces = $provinces;
        return $this;
    }
    /**
     * Get sbi_match_type value
     * @return string|null
     */
    public function getSbi_match_type()
    {
        return $this->sbi_match_type;
    }
    /**
     * Set sbi_match_type value
     * @param string $sbi_match_type
     * @return \Webservices\StructType\DutchBusinessSearchSelectionRequestType
     */
    public function setSbi_match_type($sbi_match_type = null)
    {
        // validation for constraint: string
        if (!is_null($sbi_match_type) && !is_string($sbi_match_type)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a string, "%s" given', gettype($sbi_match_type)), __LINE__);
        }
        $this->sbi_match_type = $sbi_match_type;
        return $this;
    }
    /**
