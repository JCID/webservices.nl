...
/**
 * This class stands for dutchBusinessUpdateRemoveDossierRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessUpdateRemoveDossierRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for dutchBusinessUpdateRemoveDossierRequestType
     * @uses DutchBusinessUpdateRemoveDossierRequestType::setDossier_number()
     * @uses DutchBusinessUpdateRemoveDossierRequestType::setEstablishment_number()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessUpdateRemoveDossierRequestType
     */
