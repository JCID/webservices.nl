...
/**
 * This class stands for KvkReference StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KvkReference extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for KvkReference
     * @uses KvkReference::setDossier_number()
     * @uses KvkReference::setEstablishment_number()
     * @uses KvkReference::setTrade_name()
     * @uses KvkReference::setEstablishment_city()
     * @uses KvkReference::setEstablishment_street()
     * @uses KvkReference::setCorrespondence_city()
     * @uses KvkReference::setCorrespondence_street()
     * @uses KvkReference::setIndication_economically_active()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\KvkReference
     */
