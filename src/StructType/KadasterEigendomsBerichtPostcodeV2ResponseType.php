...
/**
 * This class stands for kadasterEigendomsBerichtPostcodeV2ResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterEigendomsBerichtPostcodeV2ResponseType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for kadasterEigendomsBerichtPostcodeV2ResponseType
     * @uses KadasterEigendomsBerichtPostcodeV2ResponseType::setBerichtobjectresultaat()
     ...
     * @param \Webservices\StructType\BerichtObjectResultaatV2 $berichtobjectresultaat
     * @return \Webservices\StructType\KadasterEigendomsBerichtPostcodeV2ResponseType
     */
