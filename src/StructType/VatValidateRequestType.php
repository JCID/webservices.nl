...
/**
 * This class stands for vatValidateRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class VatValidateRequestType extends AbstractStructBase
{
    /**
     * The vat_number
     * @var string
    ...
    public $vat_number;
    /**
     * Constructor method for vatValidateRequestType
     * @uses VatValidateRequestType::setVat_number()
     ...
     * @param string $vat_number
     * @return \Webservices\StructType\VatValidateRequestType
     */
