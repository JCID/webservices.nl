...
/**
 * This class stands for CarVWEOptionsManufacture StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class CarVWEOptionsManufacture extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    public $options;
    /**
     * Constructor method for CarVWEOptionsManufacture
     * @uses CarVWEOptionsManufacture::setLicense_plate()
     * @uses CarVWEOptionsManufacture::setAtl_code()
     * @uses CarVWEOptionsManufacture::setOptions()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\CarVWEOptionsManufacture
     */
