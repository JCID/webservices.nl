...
/**
 * This class stands for areaCodeToNeighborhoodcodeResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class AreaCodeToNeighborhoodcodeResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for areaCodeToNeighborhoodcodeResponseType
     * @uses AreaCodeToNeighborhoodcodeResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\NeighborhoodPagedResult $out
     * @return \Webservices\StructType\AreaCodeToNeighborhoodcodeResponseType
     */
