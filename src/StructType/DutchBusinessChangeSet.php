...
/**
 * This class stands for DutchBusinessChangeSet StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessChangeSet extends AbstractStructBase
{
    /**
     * The period
    ...
    public $changes;
    /**
     * Constructor method for DutchBusinessChangeSet
     * @uses DutchBusinessChangeSet::setPeriod()
     * @uses DutchBusinessChangeSet::setChanges()
     ...
     * Set period value
     * @param \Webservices\StructType\DutchBusinessPeriod $period
     * @return \Webservices\StructType\DutchBusinessChangeSet
     */
