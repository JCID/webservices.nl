...
/**
 * This class stands for businessSearchSelectionV2RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BusinessSearchSelectionV2RequestType extends AbstractStructBase
{
    /**
     * The city
    ...
    public $page;
    /**
     * Constructor method for businessSearchSelectionV2RequestType
     * @uses BusinessSearchSelectionV2RequestType::setCity()
     * @uses BusinessSearchSelectionV2RequestType::setPostcode()
     * @uses BusinessSearchSelectionV2RequestType::setSbi()
     * @uses BusinessSearchSelectionV2RequestType::setPrimary_sbi_only()
     * @uses BusinessSearchSelectionV2RequestType::setLegal_forms()
     * @uses BusinessSearchSelectionV2RequestType::setEmployees_min()
     * @uses BusinessSearchSelectionV2RequestType::setEmployees_max()
     * @uses BusinessSearchSelectionV2RequestType::setEconomically_active()
     * @uses BusinessSearchSelectionV2RequestType::setFinancial_status()
     * @uses BusinessSearchSelectionV2RequestType::setChanged_since()
     * @uses BusinessSearchSelectionV2RequestType::setNew_since()
     * @uses BusinessSearchSelectionV2RequestType::setPage()
     ...
     * @param int $page
     */
    public function __construct(\Webservices\ArrayType\StringArray $city = null, \Webservices\ArrayType\StringArray $postcode = null, \Webservices\ArrayType\StringArray $sbi = null, $primary_sbi_only = null, \Webservices\ArrayType\IntArray $legal_forms = null, $employees_min = null, $employees_max = null, $economically_active = null, $financial_status = null, $changed_since = null, $new_since = null, $page = null)
    {
        $this
            ->setCity($city)
     ...
     * Set city value
     * @param \Webservices\ArrayType\StringArray $city
     * @return \Webservices\StructType\BusinessSearchSelectionV2RequestType
     */
