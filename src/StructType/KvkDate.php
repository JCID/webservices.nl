...
/**
 * This class stands for KvkDate StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KvkDate extends AbstractStructBase
{
    /**
     * The Year
     * @var int
    ...
    public $Day;
    /**
     * Constructor method for KvkDate
     * @uses KvkDate::setYear()
     * @uses KvkDate::setMonth()
     * @uses KvkDate::setDay()
     * @param int $year
     * @param int $month
     * @param int $day
     ...
     * Set Year value
     * @param int $year
     * @return \Webservices\StructType\KvkDate
     */
