...
/**
 * This class stands for dnbQuickCheckRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DnbQuickCheckRequestType extends AbstractStructBase
{
    /**
     * The company_id
     * @var string
    ...
    /**
     * Constructor method for dnbQuickCheckRequestType
     * @uses DnbQuickCheckRequestType::setCompany_id()
     * @uses DnbQuickCheckRequestType::setCompany_id_type()
     ...
     * @param string $company_id
     * @return \Webservices\StructType\DnbQuickCheckRequestType
     */
