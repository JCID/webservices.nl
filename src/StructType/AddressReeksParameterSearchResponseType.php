...
/**
 * This class stands for addressReeksParameterSearchResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class AddressReeksParameterSearchResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for addressReeksParameterSearchResponseType
     * @uses AddressReeksParameterSearchResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\PCReeksSearchPartsPagedResult $out
     * @return \Webservices\StructType\AddressReeksParameterSearchResponseType
     */
