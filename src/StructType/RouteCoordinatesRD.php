...
/**
 * This class stands for RouteCoordinatesRD StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class RouteCoordinatesRD extends AbstractStructBase
{
    /**
     * The number
     * @var int
    ...
    public $coordinates;
    /**
     * Constructor method for RouteCoordinatesRD
     * @uses RouteCoordinatesRD::setNumber()
     * @uses RouteCoordinatesRD::setCoordinates()
     * @param int $number
     ...
     * Set number value
     * @param int $number
     * @return \Webservices\StructType\RouteCoordinatesRD
     */
