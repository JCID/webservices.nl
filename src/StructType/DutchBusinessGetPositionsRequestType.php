...
/**
 * This class stands for dutchBusinessGetPositionsRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessGetPositionsRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for dutchBusinessGetPositionsRequestType
     * @uses DutchBusinessGetPositionsRequestType::setDossier_number()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessGetPositionsRequestType
     */
