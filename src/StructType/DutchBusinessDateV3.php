...
/**
 * This class stands for DutchBusinessDateV3 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessDateV3 extends AbstractStructBase
{
    /**
     * The year
    ...
    public $day;
    /**
     * Constructor method for DutchBusinessDateV3
     * @uses DutchBusinessDateV3::setYear()
     * @uses DutchBusinessDateV3::setMonth()
     * @uses DutchBusinessDateV3::setDay()
     * @param int $year
     * @param int $month
     * @param int $day
     */
     ...
     * Set year value
     * @param int $year
     * @return \Webservices\StructType\DutchBusinessDateV3
     */
