...
/**
 * This class stands for dutchBusinessSearchRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessSearchRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    public $page;
    /**
     * Constructor method for dutchBusinessSearchRequestType
     * @uses DutchBusinessSearchRequestType::setDossier_number()
     * @uses DutchBusinessSearchRequestType::setTrade_name()
     * @uses DutchBusinessSearchRequestType::setCity()
     * @uses DutchBusinessSearchRequestType::setStreet()
     * @uses DutchBusinessSearchRequestType::setPostcode()
     * @uses DutchBusinessSearchRequestType::setHouse_number()
     * @uses DutchBusinessSearchRequestType::setHouse_number_addition()
     * @uses DutchBusinessSearchRequestType::setTelephone_number()
     * @uses DutchBusinessSearchRequestType::setDomain_name()
     * @uses DutchBusinessSearchRequestType::setStrict_search()
     * @uses DutchBusinessSearchRequestType::setPage()
     ...
     * @param int $page
     */
    public function __construct($dossier_number = null, $trade_name = null, $city = null, $street = null, $postcode = null, $house_number = null, $house_number_addition = null, $telephone_number = null, $domain_name = null, $strict_search = null, $page = null)
    {
        $this
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessSearchRequestType
     */
