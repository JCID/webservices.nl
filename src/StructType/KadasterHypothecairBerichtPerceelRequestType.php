...
/**
 * This class stands for kadasterHypothecairBerichtPerceelRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterHypothecairBerichtPerceelRequestType extends AbstractStructBase
{
    /**
     * The gemeentecode
     * @var string
    ...
    public $format;
    /**
     * Constructor method for kadasterHypothecairBerichtPerceelRequestType
     * @uses KadasterHypothecairBerichtPerceelRequestType::setGemeentecode()
     * @uses KadasterHypothecairBerichtPerceelRequestType::setGemeentenaam()
     * @uses KadasterHypothecairBerichtPerceelRequestType::setSectie()
     * @uses KadasterHypothecairBerichtPerceelRequestType::setPerceelnummer()
     * @uses KadasterHypothecairBerichtPerceelRequestType::setRelatiecode()
     * @uses KadasterHypothecairBerichtPerceelRequestType::setVolgnummer()
     * @uses KadasterHypothecairBerichtPerceelRequestType::setFormat()
     ...
     * @param string $gemeentecode
     * @return \Webservices\StructType\KadasterHypothecairBerichtPerceelRequestType
     */
