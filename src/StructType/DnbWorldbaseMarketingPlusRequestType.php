...
/**
 * This class stands for dnbWorldbaseMarketingPlusRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DnbWorldbaseMarketingPlusRequestType extends AbstractStructBase
{
    /**
     * The company_id
     * @var string
    ...
    /**
     * Constructor method for dnbWorldbaseMarketingPlusRequestType
     * @uses DnbWorldbaseMarketingPlusRequestType::setCompany_id()
     * @uses DnbWorldbaseMarketingPlusRequestType::setCompany_id_type()
     ...
     * @param string $company_id
     * @return \Webservices\StructType\DnbWorldbaseMarketingPlusRequestType
     */
