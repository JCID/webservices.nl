...
/**
 * This class stands for carVWEMeldcodeCheckRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class CarVWEMeldcodeCheckRequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    public $code;
    /**
     * Constructor method for carVWEMeldcodeCheckRequestType
     * @uses CarVWEMeldcodeCheckRequestType::setLicense_plate()
     * @uses CarVWEMeldcodeCheckRequestType::setCode()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\CarVWEMeldcodeCheckRequestType
     */
