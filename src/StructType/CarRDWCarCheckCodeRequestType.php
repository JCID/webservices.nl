...
/**
 * This class stands for carRDWCarCheckCodeRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class CarRDWCarCheckCodeRequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    public $code;
    /**
     * Constructor method for carRDWCarCheckCodeRequestType
     * @uses CarRDWCarCheckCodeRequestType::setLicense_plate()
     * @uses CarRDWCarCheckCodeRequestType::setCode()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\CarRDWCarCheckCodeRequestType
     */
