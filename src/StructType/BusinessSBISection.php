...
/**
 * This class stands for BusinessSBISection StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BusinessSBISection extends AbstractStructBase
{
    /**
     * The sectioncode
     * @var string
    ...
    public $description;
    /**
     * Constructor method for BusinessSBISection
     * @uses BusinessSBISection::setSectioncode()
     * @uses BusinessSBISection::setDescription()
     ...
     * @param string $sectioncode
     * @return \Webservices\StructType\BusinessSBISection
     */
