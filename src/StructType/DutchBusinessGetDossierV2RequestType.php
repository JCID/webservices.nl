...
/**
 * This class stands for dutchBusinessGetDossierV2RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessGetDossierV2RequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for dutchBusinessGetDossierV2RequestType
     * @uses DutchBusinessGetDossierV2RequestType::setDossier_number()
     * @uses DutchBusinessGetDossierV2RequestType::setEstablishment_number()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessGetDossierV2RequestType
     */
