...
/**
 * This class stands for kvkUpdateRemoveDossierRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KvkUpdateRemoveDossierRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for kvkUpdateRemoveDossierRequestType
     * @uses KvkUpdateRemoveDossierRequestType::setDossier_number()
     * @uses KvkUpdateRemoveDossierRequestType::setEstablishment_number()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\KvkUpdateRemoveDossierRequestType
     */
