...
/**
 * This class stands for dutchBusinessGetLegalEntityRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessGetLegalEntityRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for dutchBusinessGetLegalEntityRequestType
     * @uses DutchBusinessGetLegalEntityRequestType::setDossier_number()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessGetLegalEntityRequestType
     */
