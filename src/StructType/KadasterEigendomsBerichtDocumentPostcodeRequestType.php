...
/**
 * This class stands for kadasterEigendomsBerichtDocumentPostcodeRequestType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterEigendomsBerichtDocumentPostcodeRequestType extends AbstractStructBase
{
    /**
     * The postcode
     * @var string
    ...
    public $format;
    /**
     * Constructor method for kadasterEigendomsBerichtDocumentPostcodeRequestType
     * @uses KadasterEigendomsBerichtDocumentPostcodeRequestType::setPostcode()
     * @uses KadasterEigendomsBerichtDocumentPostcodeRequestType::setHuisnummer()
     * @uses KadasterEigendomsBerichtDocumentPostcodeRequestType::setHuisnummer_toevoeging()
     * @uses KadasterEigendomsBerichtDocumentPostcodeRequestType::setFormat()
     ...
     * Set postcode value
     * @param string $postcode
     * @return \Webservices\StructType\KadasterEigendomsBerichtDocumentPostcodeRequestType
     */
