...
/**
 * This class stands for kadasterEigendomsBerichtPostcodeRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterEigendomsBerichtPostcodeRequestType extends AbstractStructBase
{
    /**
     * The postcode
     * @var string
    ...
    /**
     * Constructor method for kadasterEigendomsBerichtPostcodeRequestType
     * @uses KadasterEigendomsBerichtPostcodeRequestType::setPostcode()
     * @uses KadasterEigendomsBerichtPostcodeRequestType::setHuisnummer()
     * @uses KadasterEigendomsBerichtPostcodeRequestType::setHuisnummer_toevoeging()
     ...
     * Set postcode value
     * @param string $postcode
     * @return \Webservices\StructType\KadasterEigendomsBerichtPostcodeRequestType
     */
