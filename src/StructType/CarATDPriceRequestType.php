...
/**
 * This class stands for carATDPriceRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class CarATDPriceRequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    /**
     * Constructor method for carATDPriceRequestType
     * @uses CarATDPriceRequestType::setLicense_plate()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\CarATDPriceRequestType
     */
