...
/**
 * This class stands for kadasterLocatieBuitenland StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterLocatieBuitenland extends AbstractStructBase
{
    /**
     * The adres
    ...
    public $land;
    /**
     * Constructor method for kadasterLocatieBuitenland
     * @uses KadasterLocatieBuitenland::setAdres()
     * @uses KadasterLocatieBuitenland::setWoonplaats()
     * @uses KadasterLocatieBuitenland::setRegio()
     * @uses KadasterLocatieBuitenland::setLand()
     * @param string $adres
     ...
     * Set adres value
     * @param string $adres
     * @return \Webservices\StructType\KadasterLocatieBuitenland
     */
