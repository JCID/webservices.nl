...
/**
 * This class stands for kadasterV2GetKadastraalBerichtObjectByAdresResponseType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterV2GetKadastraalBerichtObjectByAdresResponseType extends AbstractStructBase
{
    /**
     * The resultaat
    ...
    public $resultaat;
    /**
     * Constructor method for kadasterV2GetKadastraalBerichtObjectByAdresResponseType
     * @uses KadasterV2GetKadastraalBerichtObjectByAdresResponseType::setResultaat()
     ...
     * Set resultaat value
     * @param \Webservices\StructType\KadasterV2KadastraalBerichtObjectResponse $resultaat
     * @return \Webservices\StructType\KadasterV2GetKadastraalBerichtObjectByAdresResponseType
     */
