...
/**
 * This class stands for GCRShareHolder StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class GCRShareHolder extends AbstractStructBase
{
    /**
    ...
    public $date_until;
    /**
     * Constructor method for GCRShareHolder
     * @uses GCRShareHolder::setGraydon_company_id()
     * @uses GCRShareHolder::setGraydon_person_id()
     * @uses GCRShareHolder::setIs_current()
     * @uses GCRShareHolder::setPercentage_of_shares()
     * @uses GCRShareHolder::setDate_from()
     * @uses GCRShareHolder::setDate_until()
     ...
     */
    public function __construct($graydon_company_id = null, $graydon_person_id = null, $is_current = null, $percentage_of_shares = null, $date_from = null, $date_until = null)
    {
        $this
     ...
     * @param int $graydon_company_id
     * @return \Webservices\StructType\GCRShareHolder
     */
