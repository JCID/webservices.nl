...
/**
 * This class stands for DutchBusinessMoneyV3 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessMoneyV3 extends AbstractStructBase
{
    /**
     * The amount
    ...
    public $formatted;
    /**
     * Constructor method for DutchBusinessMoneyV3
     * @uses DutchBusinessMoneyV3::setAmount()
     * @uses DutchBusinessMoneyV3::setCurrency()
     * @uses DutchBusinessMoneyV3::setFormatted()
     * @param int $amount
     ...
     * Set amount value
     * @param int $amount
     * @return \Webservices\StructType\DutchBusinessMoneyV3
     */
