...
/**
 * This class stands for carVWEVersionPriceRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class CarVWEVersionPriceRequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    public $atl_code;
    /**
     * Constructor method for carVWEVersionPriceRequestType
     * @uses CarVWEVersionPriceRequestType::setLicense_plate()
     * @uses CarVWEVersionPriceRequestType::setAtl_code()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\CarVWEVersionPriceRequestType
     */
