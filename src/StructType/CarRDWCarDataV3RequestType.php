...
/**
 * This class stands for carRDWCarDataV3RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class CarRDWCarDataV3RequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    /**
     * Constructor method for carRDWCarDataV3RequestType
     * @uses CarRDWCarDataV3RequestType::setLicense_plate()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\CarRDWCarDataV3RequestType
     */
