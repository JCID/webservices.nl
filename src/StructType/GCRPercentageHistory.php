...
/**
 * This class stands for GCRPercentageHistory StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class GCRPercentageHistory extends AbstractStructBase
{
    /**
     * The value
    ...
    public $year_month;
    /**
     * Constructor method for GCRPercentageHistory
     * @uses GCRPercentageHistory::setValue()
     * @uses GCRPercentageHistory::setYear_month()
     * @param float $value
     ...
     * Set value value
     * @param float $value
     * @return \Webservices\StructType\GCRPercentageHistory
     */
