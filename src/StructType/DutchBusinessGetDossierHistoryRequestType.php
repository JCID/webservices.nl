...
/**
 * This class stands for dutchBusinessGetDossierHistoryRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessGetDossierHistoryRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for dutchBusinessGetDossierHistoryRequestType
     * @uses DutchBusinessGetDossierHistoryRequestType::setDossier_number()
     * @uses DutchBusinessGetDossierHistoryRequestType::setPeriod_start_date()
     * @uses DutchBusinessGetDossierHistoryRequestType::setPeriod_end_date()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessGetDossierHistoryRequestType
     */
