...
/**
 * This class stands for kvkSearchDossierNumberRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KvkSearchDossierNumberRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    public $page;
    /**
     * Constructor method for kvkSearchDossierNumberRequestType
     * @uses KvkSearchDossierNumberRequestType::setDossier_number()
     * @uses KvkSearchDossierNumberRequestType::setEstablishment_number()
     * @uses KvkSearchDossierNumberRequestType::setRsin_number()
     * @uses KvkSearchDossierNumberRequestType::setPage()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\KvkSearchDossierNumberRequestType
     */
