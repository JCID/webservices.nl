...
/**
 * This class stands for DutchBusinessOrganizationReferenceV3 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessOrganizationReferenceV3 extends AbstractStructBase
{
    /**
     * The dossier_number
    ...
    public $trade_names;
    /**
     * Constructor method for DutchBusinessOrganizationReferenceV3
     * @uses DutchBusinessOrganizationReferenceV3::setDossier_number()
     * @uses DutchBusinessOrganizationReferenceV3::setRegistration()
     * @uses DutchBusinessOrganizationReferenceV3::setName()
     * @uses DutchBusinessOrganizationReferenceV3::setTrade_names()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessOrganizationReferenceV3
     */
