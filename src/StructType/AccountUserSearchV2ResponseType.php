...
/**
 * This class stands for accountUserSearchV2ResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class AccountUserSearchV2ResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for accountUserSearchV2ResponseType
     * @uses AccountUserSearchV2ResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\UserV2PagedResult $out
     * @return \Webservices\StructType\AccountUserSearchV2ResponseType
     */
