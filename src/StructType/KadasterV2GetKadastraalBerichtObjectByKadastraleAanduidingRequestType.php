 ...
 * kadasterV2GetKadastraalBerichtObjectByKadastraleAanduidingRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterV2GetKadastraalBerichtObjectByKadastraleAanduidingRequestType extends AbstractStructBase
{
    /**
     * The gemeentenaam
     * @var string
     ...
     * kadasterV2GetKadastraalBerichtObjectByKadastraleAanduidingRequestType
     * @uses KadasterV2GetKadastraalBerichtObjectByKadastraleAanduidingRequestType::setGemeentenaam()
     * @uses KadasterV2GetKadastraalBerichtObjectByKadastraleAanduidingRequestType::setSectie()
     * @uses KadasterV2GetKadastraalBerichtObjectByKadastraleAanduidingRequestType::setPerceelnummer()
     * @uses KadasterV2GetKadastraalBerichtObjectByKadastraleAanduidingRequestType::setAppartementsnummer()
     * @uses KadasterV2GetKadastraalBerichtObjectByKadastraleAanduidingRequestType::setDocument()
     ...
     * @param string $gemeentenaam
     * @return \Webservices\StructType\KadasterV2GetKadastraalBerichtObjectByKadastraleAanduidingRequestType
     */
