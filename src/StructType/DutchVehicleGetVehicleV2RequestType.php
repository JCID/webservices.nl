...
/**
 * This class stands for dutchVehicleGetVehicleV2RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchVehicleGetVehicleV2RequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    /**
     * Constructor method for dutchVehicleGetVehicleV2RequestType
     * @uses DutchVehicleGetVehicleV2RequestType::setLicense_plate()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\DutchVehicleGetVehicleV2RequestType
     */
