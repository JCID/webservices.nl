...
/**
 * This class stands for DutchBusinessAddressV3 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessAddressV3 extends AbstractStructBase
{
    /**
     * The address
    ...
    public $country;
    /**
     * Constructor method for DutchBusinessAddressV3
     * @uses DutchBusinessAddressV3::setAddress()
     * @uses DutchBusinessAddressV3::setPostcode()
     * @uses DutchBusinessAddressV3::setCity()
     * @uses DutchBusinessAddressV3::setStreet()
     * @uses DutchBusinessAddressV3::setHouse_number()
     * @uses DutchBusinessAddressV3::setHouse_number_addition()
     * @uses DutchBusinessAddressV3::setCountry()
     ...
     */
    public function __construct($address = null, $postcode = null, $city = null, $street = null, $house_number = null, $house_number_addition = null, $country = null)
    {
        $this
            ->setAddress($address)
     ...
     * Set address value
     * @param string $address
     * @return \Webservices\StructType\DutchBusinessAddressV3
     */
