...
/**
 * This class stands for routePlannerInformationDutchAddressRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class RoutePlannerInformationDutchAddressRequestType extends AbstractStructBase
{
    /**
     * The routetype
     * @var string
    ...
    public $to_city;
    /**
     * Constructor method for routePlannerInformationDutchAddressRequestType
     * @uses RoutePlannerInformationDutchAddressRequestType::setRoutetype()
     * @uses RoutePlannerInformationDutchAddressRequestType::setFrom_postalcode()
     * @uses RoutePlannerInformationDutchAddressRequestType::setFrom_housno()
     * @uses RoutePlannerInformationDutchAddressRequestType::setFrom_street()
     * @uses RoutePlannerInformationDutchAddressRequestType::setFrom_city()
     * @uses RoutePlannerInformationDutchAddressRequestType::setTo_postalcode()
     * @uses RoutePlannerInformationDutchAddressRequestType::setTo_housno()
     * @uses RoutePlannerInformationDutchAddressRequestType::setTo_street()
     * @uses RoutePlannerInformationDutchAddressRequestType::setTo_city()
     ...
     */
    public function __construct($routetype = null, $from_postalcode = null, $from_housno = null, $from_street = null, $from_city = null, $to_postalcode = null, $to_housno = null, $to_street = null, $to_city = null)
    {
        $this
     ...
     * Set routetype value
     * @param string $routetype
     * @return \Webservices\StructType\RoutePlannerInformationDutchAddressRequestType
     */
