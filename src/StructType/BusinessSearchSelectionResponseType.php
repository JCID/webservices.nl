...
/**
 * This class stands for businessSearchSelectionResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BusinessSearchSelectionResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for businessSearchSelectionResponseType
     * @uses BusinessSearchSelectionResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\BusinessReferencePagedResult $out
     * @return \Webservices\StructType\BusinessSearchSelectionResponseType
     */
