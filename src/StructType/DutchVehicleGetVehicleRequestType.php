...
/**
 * This class stands for dutchVehicleGetVehicleRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchVehicleGetVehicleRequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    /**
     * Constructor method for dutchVehicleGetVehicleRequestType
     * @uses DutchVehicleGetVehicleRequestType::setLicense_plate()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\DutchVehicleGetVehicleRequestType
     */
