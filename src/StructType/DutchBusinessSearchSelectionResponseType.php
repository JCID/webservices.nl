...
/**
 * This class stands for dutchBusinessSearchSelectionResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessSearchSelectionResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for dutchBusinessSearchSelectionResponseType
     * @uses DutchBusinessSearchSelectionResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\DutchBusinessReferencePagedResult $out
     * @return \Webservices\StructType\DutchBusinessSearchSelectionResponseType
     */
