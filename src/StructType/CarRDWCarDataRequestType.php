...
/**
 * This class stands for carRDWCarDataRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class CarRDWCarDataRequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    /**
     * Constructor method for carRDWCarDataRequestType
     * @uses CarRDWCarDataRequestType::setLicense_plate()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\CarRDWCarDataRequestType
     */
