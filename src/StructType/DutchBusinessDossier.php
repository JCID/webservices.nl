...
/**
 * This class stands for DutchBusinessDossier StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessDossier extends AbstractStructBase
{
    /**
     * The update_info
    ...
    /**
     * Constructor method for DutchBusinessDossier
     * @uses DutchBusinessDossier::setUpdate_info()
     * @uses DutchBusinessDossier::setDossier_number()
     * @uses DutchBusinessDossier::setEstablishment_number()
     * @uses DutchBusinessDossier::setMain_establishment_number()
     * @uses DutchBusinessDossier::setIndication_main_establishment()
     * @uses DutchBusinessDossier::setRsin_number()
     * @uses DutchBusinessDossier::setChamber_number()
     * @uses DutchBusinessDossier::setLegal_form_code()
     * @uses DutchBusinessDossier::setLegal_form_text()
     * @uses DutchBusinessDossier::setIndication_organisation_code()
     * @uses DutchBusinessDossier::setLegal_name()
     * @uses DutchBusinessDossier::setTrade_name_45()
     * @uses DutchBusinessDossier::setTrade_name_full()
     * @uses DutchBusinessDossier::setTrade_names()
     * @uses DutchBusinessDossier::setEstablishment_postcode()
     * @uses DutchBusinessDossier::setEstablishment_city()
     * @uses DutchBusinessDossier::setEstablishment_street()
     * @uses DutchBusinessDossier::setEstablishment_house_number()
     * @uses DutchBusinessDossier::setEstablishment_house_number_addition()
     * @uses DutchBusinessDossier::setCorrespondence_postcode()
     * @uses DutchBusinessDossier::setCorrespondence_city()
     * @uses DutchBusinessDossier::setCorrespondence_street()
     * @uses DutchBusinessDossier::setCorrespondence_house_number()
     * @uses DutchBusinessDossier::setCorrespondence_house_number_addition()
     * @uses DutchBusinessDossier::setCorrespondence_country()
     * @uses DutchBusinessDossier::setTelephone_number()
     * @uses DutchBusinessDossier::setMobile_number()
     * @uses DutchBusinessDossier::setDomain_name()
     * @uses DutchBusinessDossier::setContact_title1()
     * @uses DutchBusinessDossier::setContact_title2()
     * @uses DutchBusinessDossier::setContact_initials()
     * @uses DutchBusinessDossier::setContact_prefix()
     * @uses DutchBusinessDossier::setContact_surname()
     * @uses DutchBusinessDossier::setContact_gender()
     * @uses DutchBusinessDossier::setPrimary_sbi_code()
     * @uses DutchBusinessDossier::setSecondary_sbi_code1()
     * @uses DutchBusinessDossier::setSecondary_sbi_code2()
     * @uses DutchBusinessDossier::setPrimary_sbi_code_text()
     * @uses DutchBusinessDossier::setSecondary_sbi_code1_text()
     * @uses DutchBusinessDossier::setSecondary_sbi_code2_text()
     * @uses DutchBusinessDossier::setPersonnel()
     * @uses DutchBusinessDossier::setClass_personnel()
     * @uses DutchBusinessDossier::setPersonnel_fulltime()
     * @uses DutchBusinessDossier::setClass_personnel_fulltime()
     * @uses DutchBusinessDossier::setPersonnel_reference_date()
     * @uses DutchBusinessDossier::setIndication_import()
     * @uses DutchBusinessDossier::setIndication_export()
     * @uses DutchBusinessDossier::setIndication_economically_active()
     * @uses DutchBusinessDossier::setIndication_non_mailing()
     * @uses DutchBusinessDossier::setIndication_bankruptcy()
     * @uses DutchBusinessDossier::setIndication_dip()
     * @uses DutchBusinessDossier::setAuthorized_share_capital()
     * @uses DutchBusinessDossier::setAuthorized_share_capital_currency()
     * @uses DutchBusinessDossier::setPaid_up_share_capital()
     * @uses DutchBusinessDossier::setPaid_up_share_capital_currency()
     * @uses DutchBusinessDossier::setIssued_share_capital()
     * @uses DutchBusinessDossier::setIssued_share_capital_currency()
     * @uses DutchBusinessDossier::setFounding_date()
     * @uses DutchBusinessDossier::setContinuation_date()
     * @uses DutchBusinessDossier::setEstablishment_date()
     ...
     * @param \Webservices\StructType\DutchBusinessDate $personnel_reference_date
     ...
     * @param \Webservices\StructType\DutchBusinessDate $continuation_date
     ...
     * @param \Webservices\StructType\DutchBusinessUpdateReference $update_info
     * @return \Webservices\StructType\DutchBusinessDossier
     */
     ...
     * @return \Webservices\StructType\DutchBusinessDossier
     */
    public function setPersonnel_reference_date(\Webservices\StructType\DutchBusinessDate $personnel_reference_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessDossier
     */
    public function setContinuation_date(\Webservices\StructType\DutchBusinessDate $continuation_date = null)
    {
