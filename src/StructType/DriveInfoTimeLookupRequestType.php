...
/**
 * This class stands for driveInfoTimeLookupRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DriveInfoTimeLookupRequestType extends AbstractStructBase
{
    /**
     * The nbcodefrom
     * @var string
    ...
    public $nbcodeto;
    /**
     * Constructor method for driveInfoTimeLookupRequestType
     * @uses DriveInfoTimeLookupRequestType::setNbcodefrom()
     * @uses DriveInfoTimeLookupRequestType::setNbcodeto()
     ...
     * @param string $nbcodefrom
     * @return \Webservices\StructType\DriveInfoTimeLookupRequestType
     */
