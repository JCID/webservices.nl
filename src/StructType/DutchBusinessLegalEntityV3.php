...
/**
 * This class stands for DutchBusinessLegalEntityV3 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessLegalEntityV3 extends AbstractStructBase
{
    /**
     * The rsin_number
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \Webservices\StructType\DutchBusinessMoneyV3
     */
    ...
    public $sbi_codes;
    /**
     * Constructor method for DutchBusinessLegalEntityV3
     * @uses DutchBusinessLegalEntityV3::setRsin_number()
     * @uses DutchBusinessLegalEntityV3::setName()
     * @uses DutchBusinessLegalEntityV3::setAlternative_name()
     * @uses DutchBusinessLegalEntityV3::setShortened_name()
     * @uses DutchBusinessLegalEntityV3::setRegistration()
     * @uses DutchBusinessLegalEntityV3::setLegal_form_text()
     * @uses DutchBusinessLegalEntityV3::setLegal_form_change()
     * @uses DutchBusinessLegalEntityV3::setForeign_legal_form_description()
     * @uses DutchBusinessLegalEntityV3::setActivity()
     * @uses DutchBusinessLegalEntityV3::setCompany_arrangement()
     * @uses DutchBusinessLegalEntityV3::setLegal_name()
     * @uses DutchBusinessLegalEntityV3::setStatutory_seat()
     * @uses DutchBusinessLegalEntityV3::setRegistration_date()
     * @uses DutchBusinessLegalEntityV3::setFounding_date()
     * @uses DutchBusinessLegalEntityV3::setDiscontinuation_date()
     * @uses DutchBusinessLegalEntityV3::setDissolution_date()
     * @uses DutchBusinessLegalEntityV3::setDissolution_reason()
     * @uses DutchBusinessLegalEntityV3::setRemoval_date()
     * @uses DutchBusinessLegalEntityV3::setRegistration_end_date()
     * @uses DutchBusinessLegalEntityV3::setLegal_entity_end_date()
     * @uses DutchBusinessLegalEntityV3::setLiquidation_closure_date()
     * @uses DutchBusinessLegalEntityV3::setLiquidation_reopening_date()
     * @uses DutchBusinessLegalEntityV3::setDeed_incorporation_date()
     * @uses DutchBusinessLegalEntityV3::setDeed_last_statutes_amendment_date()
     * @uses DutchBusinessLegalEntityV3::setLast_statutes_amendment_date()
     * @uses DutchBusinessLegalEntityV3::setLiability()
     * @uses DutchBusinessLegalEntityV3::setMerger_description()
     * @uses DutchBusinessLegalEntityV3::setAnnual_report_submission()
     * @uses DutchBusinessLegalEntityV3::setAuthorized_share_capital()
     * @uses DutchBusinessLegalEntityV3::setIssued_share_capital()
     * @uses DutchBusinessLegalEntityV3::setPaid_up_share_capital()
     * @uses DutchBusinessLegalEntityV3::setDuration()
     * @uses DutchBusinessLegalEntityV3::setDuration_end_date()
     * @uses DutchBusinessLegalEntityV3::setShares()
     * @uses DutchBusinessLegalEntityV3::setShare_holders()
     * @uses DutchBusinessLegalEntityV3::setRemarks()
     * @uses DutchBusinessLegalEntityV3::setEstablishment_address()
     * @uses DutchBusinessLegalEntityV3::setCorrespondence_address()
     * @uses DutchBusinessLegalEntityV3::setTelephone_numbers()
     * @uses DutchBusinessLegalEntityV3::setFax_numbers()
     * @uses DutchBusinessLegalEntityV3::setEmail_addresses()
     * @uses DutchBusinessLegalEntityV3::setDomain_names()
     * @uses DutchBusinessLegalEntityV3::setSbi_codes()
     ...
     * @param \Webservices\StructType\DutchBusinessDateV3 $registration_date
     ...
     * @param \Webservices\StructType\DutchBusinessDateV3 $dissolution_date
     * @param string $dissolution_reason
     * @param \Webservices\StructType\DutchBusinessDateV3 $removal_date
     * @param \Webservices\StructType\DutchBusinessDateV3 $registration_end_date
     * @param \Webservices\StructType\DutchBusinessDateV3 $legal_entity_end_date
     * @param \Webservices\StructType\DutchBusinessDateV3 $liquidation_closure_date
     * @param \Webservices\StructType\DutchBusinessDateV3 $liquidation_reopening_date
     * @param \Webservices\StructType\DutchBusinessDateV3 $deed_incorporation_date
     * @param \Webservices\StructType\DutchBusinessDateV3 $deed_last_statutes_amendment_date
     * @param \Webservices\StructType\DutchBusinessDateV3 $last_statutes_amendment_date
     * @param string $liability
     * @param string $merger_description
     * @param string $annual_report_submission
     * @param \Webservices\StructType\DutchBusinessMoneyV3 $authorized_share_capital
     * @param \Webservices\StructType\DutchBusinessMoneyV3 $issued_share_capital
     * @param \Webservices\StructType\DutchBusinessMoneyV3 $paid_up_share_capital
     * @param string $duration
     * @param \Webservices\StructType\DutchBusinessDateV3 $duration_end_date
     * @param string $shares
     ...
     */
    public function __construct($rsin_number = null, $name = null, $alternative_name = null, $shortened_name = null, $registration = null, $legal_form_text = null, $legal_form_change = null, $foreign_legal_form_description = null, $activity = null, $company_arrangement = null, $legal_name = null, $statutory_seat = null, \Webservices\StructType\DutchBusinessDateV3 $registration_date = null, \Webservices\StructType\DutchBusinessDateV3 $founding_date = null, \Webservices\StructType\DutchBusinessDateV3 $discontinuation_date = null, \Webservices\StructType\DutchBusinessDateV3 $dissolution_date = null, $dissolution_reason = null, \Webservices\StructType\DutchBusinessDateV3 $removal_date = null, \Webservices\StructType\DutchBusinessDateV3 $registration_end_date = null, \Webservices\StructType\DutchBusinessDateV3 $legal_entity_end_date = null, \Webservices\StructType\DutchBusinessDateV3 $liquidation_closure_date = null, \Webservices\StructType\DutchBusinessDateV3 $liquidation_reopening_date = null, \Webservices\StructType\DutchBusinessDateV3 $deed_incorporation_date = null, \Webservices\StructType\DutchBusinessDateV3 $deed_last_statutes_amendment_date = null, \Webservices\StructType\DutchBusinessDateV3 $last_statutes_amendment_date = null, $liability = null, $merger_description = null, $annual_report_submission = null, \Webservices\StructType\DutchBusinessMoneyV3 $authorized_share_capital = null, \Webservices\StructType\DutchBusinessMoneyV3 $issued_share_capital = null, \Webservices\StructType\DutchBusinessMoneyV3 $paid_up_share_capital = null, $duration = null, \Webservices\StructType\DutchBusinessDateV3 $duration_end_date = null, $shares = null, $share_holders = null, \Webservices\ArrayType\StringArray $remarks = null, \Webservices\StructType\DutchBusinessAddressV3 $establishment_address = null, \Webservices\StructType\DutchBusinessAddressV3 $correspondence_address = null, \Webservices\ArrayType\StringArray $telephone_numbers = null, \Webservices\ArrayType\StringArray $fax_numbers = null, \Webservices\ArrayType\StringArray $email_addresses = null, \Webservices\ArrayType\StringArray $domain_names = null, \Webservices\ArrayType\DutchBusinessSbiCodeV3Array $sbi_codes = null)
    {
        $this
     ...
     * @param string $rsin_number
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
     ...
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
    public function setRegistration_date(\Webservices\StructType\DutchBusinessDateV3 $registration_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
    public function setDissolution_date(\Webservices\StructType\DutchBusinessDateV3 $dissolution_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
    public function setRemoval_date(\Webservices\StructType\DutchBusinessDateV3 $removal_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
    public function setRegistration_end_date(\Webservices\StructType\DutchBusinessDateV3 $registration_end_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
    public function setLegal_entity_end_date(\Webservices\StructType\DutchBusinessDateV3 $legal_entity_end_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
    public function setLiquidation_closure_date(\Webservices\StructType\DutchBusinessDateV3 $liquidation_closure_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
    public function setLiquidation_reopening_date(\Webservices\StructType\DutchBusinessDateV3 $liquidation_reopening_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
    public function setDeed_incorporation_date(\Webservices\StructType\DutchBusinessDateV3 $deed_incorporation_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
    public function setDeed_last_statutes_amendment_date(\Webservices\StructType\DutchBusinessDateV3 $deed_last_statutes_amendment_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
    public function setLast_statutes_amendment_date(\Webservices\StructType\DutchBusinessDateV3 $last_statutes_amendment_date = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessMoneyV3|null
     */
     ...
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
    public function setAuthorized_share_capital(\Webservices\StructType\DutchBusinessMoneyV3 $authorized_share_capital = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
    public function setIssued_share_capital(\Webservices\StructType\DutchBusinessMoneyV3 $issued_share_capital = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
    public function setPaid_up_share_capital(\Webservices\StructType\DutchBusinessMoneyV3 $paid_up_share_capital = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessLegalEntityV3
     */
    public function setDuration_end_date(\Webservices\StructType\DutchBusinessDateV3 $duration_end_date = null)
    {
