...
/**
 * This class stands for businessSearchDossierNumberRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BusinessSearchDossierNumberRequestType extends AbstractStructBase
{
    /**
     * The dossierno
     * @var string
    ...
    public $page;
    /**
     * Constructor method for businessSearchDossierNumberRequestType
     * @uses BusinessSearchDossierNumberRequestType::setDossierno()
     * @uses BusinessSearchDossierNumberRequestType::setSubdossierno()
     * @uses BusinessSearchDossierNumberRequestType::setPage()
     ...
     * Set dossierno value
     * @param string $dossierno
     * @return \Webservices\StructType\BusinessSearchDossierNumberRequestType
     */
