...
/**
 * This class stands for DutchBusinessPartnershipV3 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessPartnershipV3 extends AbstractStructBase
{
    /**
     * The dossier_number
    ...
    public $remarks;
    /**
     * Constructor method for DutchBusinessPartnershipV3
     * @uses DutchBusinessPartnershipV3::setDossier_number()
     * @uses DutchBusinessPartnershipV3::setRsin_number()
     * @uses DutchBusinessPartnershipV3::setName()
     * @uses DutchBusinessPartnershipV3::setRegistration()
     * @uses DutchBusinessPartnershipV3::setLegal_form_text()
     * @uses DutchBusinessPartnershipV3::setFounding_date()
     * @uses DutchBusinessPartnershipV3::setDissolution_date()
     * @uses DutchBusinessPartnershipV3::setFunction_start_date()
     * @uses DutchBusinessPartnershipV3::setDuration()
     * @uses DutchBusinessPartnershipV3::setLimited_partnership_capital()
     * @uses DutchBusinessPartnershipV3::setEstablishment_address()
     * @uses DutchBusinessPartnershipV3::setCorrespondence_address()
     * @uses DutchBusinessPartnershipV3::setSilent_partners()
     * @uses DutchBusinessPartnershipV3::setRemarks()
     ...
     * @param \Webservices\StructType\DutchBusinessMoneyV3 $limited_partnership_capital
     ...
     */
    public function __construct($dossier_number = null, $rsin_number = null, $name = null, $registration = null, $legal_form_text = null, \Webservices\StructType\DutchBusinessDateV3 $founding_date = null, \Webservices\StructType\DutchBusinessDateV3 $dissolution_date = null, \Webservices\StructType\DutchBusinessDateV3 $function_start_date = null, $duration = null, \Webservices\StructType\DutchBusinessMoneyV3 $limited_partnership_capital = null, \Webservices\StructType\DutchBusinessAddressV3 $establishment_address = null, \Webservices\StructType\DutchBusinessAddressV3 $correspondence_address = null, $silent_partners = null, \Webservices\ArrayType\StringArray $remarks = null)
    {
        $this
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessPartnershipV3
     */
     ...
     * @return \Webservices\StructType\DutchBusinessPartnershipV3
     */
    public function setLimited_partnership_capital(\Webservices\StructType\DutchBusinessMoneyV3 $limited_partnership_capital = null)
    {
