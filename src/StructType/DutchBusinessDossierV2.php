...
/**
 * This class stands for DutchBusinessDossierV2 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessDossierV2 extends AbstractStructBase
{
    /**
     * The update_info
    ...
    /**
     * Constructor method for DutchBusinessDossierV2
     * @uses DutchBusinessDossierV2::setUpdate_info()
     * @uses DutchBusinessDossierV2::setDossier_number()
     * @uses DutchBusinessDossierV2::setEstablishment_number()
     * @uses DutchBusinessDossierV2::setMain_establishment_number()
     * @uses DutchBusinessDossierV2::setIndication_main_establishment()
     * @uses DutchBusinessDossierV2::setRsin_number()
     * @uses DutchBusinessDossierV2::setChamber_number()
     * @uses DutchBusinessDossierV2::setLegal_form_code()
     * @uses DutchBusinessDossierV2::setLegal_form_text()
     * @uses DutchBusinessDossierV2::setIndication_organisation_code()
     * @uses DutchBusinessDossierV2::setLegal_name()
     * @uses DutchBusinessDossierV2::setTrade_name_45()
     * @uses DutchBusinessDossierV2::setTrade_name_full()
     * @uses DutchBusinessDossierV2::setTrade_names()
     * @uses DutchBusinessDossierV2::setEstablishment_postcode()
     * @uses DutchBusinessDossierV2::setEstablishment_city()
     * @uses DutchBusinessDossierV2::setEstablishment_street()
     * @uses DutchBusinessDossierV2::setEstablishment_house_number()
     * @uses DutchBusinessDossierV2::setEstablishment_house_number_addition()
     * @uses DutchBusinessDossierV2::setCorrespondence_postcode()
     * @uses DutchBusinessDossierV2::setCorrespondence_city()
     * @uses DutchBusinessDossierV2::setCorrespondence_street()
     * @uses DutchBusinessDossierV2::setCorrespondence_house_number()
     * @uses DutchBusinessDossierV2::setCorrespondence_house_number_addition()
     * @uses DutchBusinessDossierV2::setCorrespondence_country()
     * @uses DutchBusinessDossierV2::setTelephone_number()
     * @uses DutchBusinessDossierV2::setMobile_number()
     * @uses DutchBusinessDossierV2::setDomain_name()
     * @uses DutchBusinessDossierV2::setContact_title1()
     * @uses DutchBusinessDossierV2::setContact_title2()
     * @uses DutchBusinessDossierV2::setContact_initials()
     * @uses DutchBusinessDossierV2::setContact_prefix()
     * @uses DutchBusinessDossierV2::setContact_surname()
     * @uses DutchBusinessDossierV2::setContact_gender()
     * @uses DutchBusinessDossierV2::setPrimary_sbi_code()
     * @uses DutchBusinessDossierV2::setSecondary_sbi_code1()
     * @uses DutchBusinessDossierV2::setSecondary_sbi_code2()
     * @uses DutchBusinessDossierV2::setPrimary_sbi_code_text()
     * @uses DutchBusinessDossierV2::setSecondary_sbi_code1_text()
     * @uses DutchBusinessDossierV2::setSecondary_sbi_code2_text()
     * @uses DutchBusinessDossierV2::setPersonnel()
     * @uses DutchBusinessDossierV2::setClass_personnel()
     * @uses DutchBusinessDossierV2::setPersonnel_fulltime()
     * @uses DutchBusinessDossierV2::setClass_personnel_fulltime()
     * @uses DutchBusinessDossierV2::setPersonnel_reference_date()
     * @uses DutchBusinessDossierV2::setPersonnel_ci()
     * @uses DutchBusinessDossierV2::setClass_personnel_ci()
     * @uses DutchBusinessDossierV2::setPersonnel_ci_reference_date()
     * @uses DutchBusinessDossierV2::setIndication_import()
     * @uses DutchBusinessDossierV2::setIndication_export()
     * @uses DutchBusinessDossierV2::setIndication_economically_active()
     * @uses DutchBusinessDossierV2::setIndication_non_mailing()
     * @uses DutchBusinessDossierV2::setIndication_bankruptcy()
     * @uses DutchBusinessDossierV2::setIndication_dip()
     * @uses DutchBusinessDossierV2::setAuthorized_share_capital()
     * @uses DutchBusinessDossierV2::setAuthorized_share_capital_currency()
     * @uses DutchBusinessDossierV2::setPaid_up_share_capital()
     * @uses DutchBusinessDossierV2::setPaid_up_share_capital_currency()
     * @uses DutchBusinessDossierV2::setIssued_share_capital()
     * @uses DutchBusinessDossierV2::setIssued_share_capital_currency()
     * @uses DutchBusinessDossierV2::setFounding_date()
     * @uses DutchBusinessDossierV2::setDiscontinuation_date()
     * @uses DutchBusinessDossierV2::setContinuation_date()
     * @uses DutchBusinessDossierV2::setEstablishment_date()
     * @uses DutchBusinessDossierV2::setAnnual_financial_statement_summary()
     * @uses DutchBusinessDossierV2::setStructure()
     * @uses DutchBusinessDossierV2::setSbi_collection()
