...
/**
 * This class stands for dutchBusinessGetExtractDocumentDataV3ResponseType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessGetExtractDocumentDataV3ResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for dutchBusinessGetExtractDocumentDataV3ResponseType
     * @uses DutchBusinessGetExtractDocumentDataV3ResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\DutchBusinessExtractDocumentDataV3 $out
     * @return \Webservices\StructType\DutchBusinessGetExtractDocumentDataV3ResponseType
     */
