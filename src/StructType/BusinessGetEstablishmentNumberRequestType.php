...
/**
 * This class stands for businessGetEstablishmentNumberRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BusinessGetEstablishmentNumberRequestType extends AbstractStructBase
{
    /**
     * The dossierno
     * @var string
    ...
    public $subdossierno;
    /**
     * Constructor method for businessGetEstablishmentNumberRequestType
     * @uses BusinessGetEstablishmentNumberRequestType::setDossierno()
     * @uses BusinessGetEstablishmentNumberRequestType::setSubdossierno()
     ...
     * Set dossierno value
     * @param string $dossierno
     * @return \Webservices\StructType\BusinessGetEstablishmentNumberRequestType
     */
