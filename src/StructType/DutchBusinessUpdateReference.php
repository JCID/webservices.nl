...
/**
 * This class stands for DutchBusinessUpdateReference StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessUpdateReference extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for DutchBusinessUpdateReference
     * @uses DutchBusinessUpdateReference::setDossier_number()
     * @uses DutchBusinessUpdateReference::setEstablishment_number()
     * @uses DutchBusinessUpdateReference::setUpdate_types()
     * @uses DutchBusinessUpdateReference::setDate_last_update()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessUpdateReference
     */
