...
/**
 * This class stands for kvkUpdateGetDossiersRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KvkUpdateGetDossiersRequestType extends AbstractStructBase
{
    /**
     * The update_types
    ...
    public $page;
    /**
     * Constructor method for kvkUpdateGetDossiersRequestType
     * @uses KvkUpdateGetDossiersRequestType::setUpdate_types()
     * @uses KvkUpdateGetDossiersRequestType::setPage()
     ...
     * @param \Webservices\ArrayType\StringArray $update_types
     * @return \Webservices\StructType\KvkUpdateGetDossiersRequestType
     */
