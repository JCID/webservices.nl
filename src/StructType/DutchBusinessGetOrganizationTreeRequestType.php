...
/**
 * This class stands for dutchBusinessGetOrganizationTreeRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessGetOrganizationTreeRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for dutchBusinessGetOrganizationTreeRequestType
     * @uses DutchBusinessGetOrganizationTreeRequestType::setDossier_number()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessGetOrganizationTreeRequestType
     */
