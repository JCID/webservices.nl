...
/**
 * This class stands for businessSearchAddressResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BusinessSearchAddressResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for businessSearchAddressResponseType
     * @uses BusinessSearchAddressResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\BusinessReferencePagedResult $out
     * @return \Webservices\StructType\BusinessSearchAddressResponseType
     */
