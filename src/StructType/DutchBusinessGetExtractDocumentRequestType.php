...
/**
 * This class stands for dutchBusinessGetExtractDocumentRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessGetExtractDocumentRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for dutchBusinessGetExtractDocumentRequestType
     * @uses DutchBusinessGetExtractDocumentRequestType::setDossier_number()
     * @uses DutchBusinessGetExtractDocumentRequestType::setAllow_caching()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessGetExtractDocumentRequestType
     */
