...
/**
 * This class stands for kadasterEigendomsBerichtPostcodeV2RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterEigendomsBerichtPostcodeV2RequestType extends AbstractStructBase
{
    /**
     * The postcode
     * @var string
    ...
    /**
     * Constructor method for kadasterEigendomsBerichtPostcodeV2RequestType
     * @uses KadasterEigendomsBerichtPostcodeV2RequestType::setPostcode()
     * @uses KadasterEigendomsBerichtPostcodeV2RequestType::setHuisnummer()
     * @uses KadasterEigendomsBerichtPostcodeV2RequestType::setHuisnummer_toevoeging()
     * @param string $postcode
     * @param int $huisnummer
     * @param string $huisnummer_toevoeging
     */
    public function __construct($postcode = null, $huisnummer = null, $huisnummer_toevoeging = null)
    {
        $this
     ...
     * Set postcode value
     * @param string $postcode
     * @return \Webservices\StructType\KadasterEigendomsBerichtPostcodeV2RequestType
     */
