...
/**
 * This class stands for addressPerceelFullParameterSearchV2RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class AddressPerceelFullParameterSearchV2RequestType extends AbstractStructBase
{
    /**
     * The province
     * @var string
    ...
    public $page;
    /**
     * Constructor method for addressPerceelFullParameterSearchV2RequestType
     * @uses AddressPerceelFullParameterSearchV2RequestType::setProvince()
     * @uses AddressPerceelFullParameterSearchV2RequestType::setDistrict()
     * @uses AddressPerceelFullParameterSearchV2RequestType::setCity()
     * @uses AddressPerceelFullParameterSearchV2RequestType::setStreet()
     * @uses AddressPerceelFullParameterSearchV2RequestType::setHouseNo()
     * @uses AddressPerceelFullParameterSearchV2RequestType::setHouseNoAddition()
     * @uses AddressPerceelFullParameterSearchV2RequestType::setNbcode()
     * @uses AddressPerceelFullParameterSearchV2RequestType::setLettercombination()
     * @uses AddressPerceelFullParameterSearchV2RequestType::setAddresstype()
     * @uses AddressPerceelFullParameterSearchV2RequestType::setPage()
     ...
     * Set province value
     * @param string $province
     * @return \Webservices\StructType\AddressPerceelFullParameterSearchV2RequestType
     */
