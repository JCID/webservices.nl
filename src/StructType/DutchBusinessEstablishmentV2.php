...
/**
 * This class stands for DutchBusinessEstablishmentV2 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessEstablishmentV2 extends AbstractStructBase
{
    /**
    ...
    public $trade_names;
    /**
     * Constructor method for DutchBusinessEstablishmentV2
     * @uses DutchBusinessEstablishmentV2::setEstablishment_number()
     * @uses DutchBusinessEstablishmentV2::setMain_establishment()
     * @uses DutchBusinessEstablishmentV2::setLegal_form_text()
     * @uses DutchBusinessEstablishmentV2::setActivity()
     * @uses DutchBusinessEstablishmentV2::setDescription()
     * @uses DutchBusinessEstablishmentV2::setEstablishment_date()
     * @uses DutchBusinessEstablishmentV2::setDate_since()
     * @uses DutchBusinessEstablishmentV2::setPersonnel()
     * @uses DutchBusinessEstablishmentV2::setRemarks()
     * @uses DutchBusinessEstablishmentV2::setSbi_codes()
     * @uses DutchBusinessEstablishmentV2::setEstablishment_address()
     * @uses DutchBusinessEstablishmentV2::setCorrespondence_address()
     * @uses DutchBusinessEstablishmentV2::setTelephone_numbers()
     * @uses DutchBusinessEstablishmentV2::setFax_numbers()
     * @uses DutchBusinessEstablishmentV2::setEmail_addresses()
     * @uses DutchBusinessEstablishmentV2::setDomain_names()
     * @uses DutchBusinessEstablishmentV2::setTrade_names()
     ...
     */
    public function __construct($establishment_number = null, $main_establishment = null, $legal_form_text = null, $activity = null, $description = null, \Webservices\StructType\DutchBusinessDateV2 $establishment_date = null, \Webservices\StructType\DutchBusinessDateV2 $date_since = null, \Webservices\StructType\DutchBusinessPersonnelInfoV2 $personnel = null, \Webservices\ArrayType\StringArray $remarks = null, \Webservices\ArrayType\DutchBusinessSbiCodeV2Array $sbi_codes = null, \Webservices\StructType\DutchBusinessAddressV2 $establishment_address = null, \Webservices\StructType\DutchBusinessAddressV2 $correspondence_address = null, \Webservices\ArrayType\StringArray $telephone_numbers = null, \Webservices\ArrayType\StringArray $fax_numbers = null, \Webservices\ArrayType\StringArray $email_addresses = null, \Webservices\ArrayType\StringArray $domain_names = null, \Webservices\ArrayType\StringArray $trade_names = null)
    {
        $this
     ...
     * @param string $establishment_number
     * @return \Webservices\StructType\DutchBusinessEstablishmentV2
     */
