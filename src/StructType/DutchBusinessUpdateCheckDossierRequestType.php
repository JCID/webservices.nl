...
/**
 * This class stands for dutchBusinessUpdateCheckDossierRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessUpdateCheckDossierRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    public $update_types;
    /**
     * Constructor method for dutchBusinessUpdateCheckDossierRequestType
     * @uses DutchBusinessUpdateCheckDossierRequestType::setDossier_number()
     * @uses DutchBusinessUpdateCheckDossierRequestType::setEstablishment_number()
     * @uses DutchBusinessUpdateCheckDossierRequestType::setUpdate_types()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessUpdateCheckDossierRequestType
     */
