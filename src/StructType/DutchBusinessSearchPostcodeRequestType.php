...
/**
 * This class stands for dutchBusinessSearchPostcodeRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessSearchPostcodeRequestType extends AbstractStructBase
{
    /**
     * The postcode
     * @var string
    ...
    public $page;
    /**
     * Constructor method for dutchBusinessSearchPostcodeRequestType
     * @uses DutchBusinessSearchPostcodeRequestType::setPostcode()
     * @uses DutchBusinessSearchPostcodeRequestType::setHouse_number()
     * @uses DutchBusinessSearchPostcodeRequestType::setHouse_number_addition()
     * @uses DutchBusinessSearchPostcodeRequestType::setPage()
     ...
     * Set postcode value
     * @param string $postcode
     * @return \Webservices\StructType\DutchBusinessSearchPostcodeRequestType
     */
