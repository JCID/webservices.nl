...
/**
 * This class stands for Persoon StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class Persoon extends AbstractStructBase
{
    /**
     * The id
     * @var string
     ...
     * - minOccurs: 0
     * @var \Webservices\StructType\NatuurlijkPersoon
     */
    ...
    /**
     * Constructor method for Persoon
     * @uses Persoon::setId()
     * @uses Persoon::setNatuurlijk_persoon()
     * @uses Persoon::setNiet_natuurlijk_persoon()
     * @uses Persoon::setAantekening_beschikkingsbevoegdheid()
     * @uses Persoon::setIndicatie_meer_onroerende_zaken()
     * @uses Persoon::setWoonlocatie()
     * @uses Persoon::setPostlocatie()
     * @uses Persoon::setNiet_volledig_verwerkt_stukken_lijst()
     * @uses Persoon::setMogelijk_van_belang_stukken_lijst()
     * @param string $id
     * @param \Webservices\StructType\NatuurlijkPersoon $natuurlijk_persoon
     ...
     */
    public function __construct($id = null, \Webservices\StructType\NatuurlijkPersoon $natuurlijk_persoon = null, \Webservices\StructType\NietNatuurlijkPersoon $niet_natuurlijk_persoon = null, $aantekening_beschikkingsbevoegdheid = null, $indicatie_meer_onroerende_zaken = null, \Webservices\StructType\Locatie $woonlocatie = null, \Webservices\StructType\Locatie $postlocatie = null, \Webservices\StructType\StukReferentiesLijst $niet_volledig_verwerkt_stukken_lijst = null, \Webservices\StructType\StukReferentiesLijst $mogelijk_van_belang_stukken_lijst = null)
    {
        $this
            ->setId($id)
     ...
     * Set id value
     * @param string $id
     * @return \Webservices\StructType\Persoon
     */
     ...
     * @return \Webservices\StructType\NatuurlijkPersoon|null
     */
     ...
     * @return \Webservices\StructType\Persoon
     */
    public function setNatuurlijk_persoon(\Webservices\StructType\NatuurlijkPersoon $natuurlijk_persoon = null)
    {
