...
/**
 * This class stands for addressReeksParameterSearchRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class AddressReeksParameterSearchRequestType extends AbstractStructBase
{
    /**
     * The province
     * @var string
    ...
    public $page;
    /**
     * Constructor method for addressReeksParameterSearchRequestType
     * @uses AddressReeksParameterSearchRequestType::setProvince()
     * @uses AddressReeksParameterSearchRequestType::setDistrict()
     * @uses AddressReeksParameterSearchRequestType::setCity()
     * @uses AddressReeksParameterSearchRequestType::setStreet()
     * @uses AddressReeksParameterSearchRequestType::setHouseNo()
     * @uses AddressReeksParameterSearchRequestType::setHouseNoAddition()
     * @uses AddressReeksParameterSearchRequestType::setPage()
     ...
     * Set province value
     * @param string $province
     * @return \Webservices\StructType\AddressReeksParameterSearchRequestType
     */
