...
/**
 * This class stands for kadasterEigendomsBerichtPerceelV2RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterEigendomsBerichtPerceelV2RequestType extends AbstractStructBase
{
    /**
     * The gemeentecode
     * @var string
    ...
    public $volgnummer;
    /**
     * Constructor method for kadasterEigendomsBerichtPerceelV2RequestType
     * @uses KadasterEigendomsBerichtPerceelV2RequestType::setGemeentecode()
     * @uses KadasterEigendomsBerichtPerceelV2RequestType::setGemeentenaam()
     * @uses KadasterEigendomsBerichtPerceelV2RequestType::setSectie()
     * @uses KadasterEigendomsBerichtPerceelV2RequestType::setPerceelnummer()
     * @uses KadasterEigendomsBerichtPerceelV2RequestType::setRelatiecode()
     * @uses KadasterEigendomsBerichtPerceelV2RequestType::setVolgnummer()
     ...
     * @param string $gemeentecode
     * @return \Webservices\StructType\KadasterEigendomsBerichtPerceelV2RequestType
     */
