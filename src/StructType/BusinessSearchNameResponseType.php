...
/**
 * This class stands for businessSearchNameResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BusinessSearchNameResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for businessSearchNameResponseType
     * @uses BusinessSearchNameResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\BusinessReferencePagedResult $out
     * @return \Webservices\StructType\BusinessSearchNameResponseType
     */
