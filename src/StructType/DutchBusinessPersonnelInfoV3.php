...
/**
 * This class stands for DutchBusinessPersonnelInfoV3 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessPersonnelInfoV3 extends AbstractStructBase
{
    /**
     * The fulltime
    ...
    public $total;
    /**
     * Constructor method for DutchBusinessPersonnelInfoV3
     * @uses DutchBusinessPersonnelInfoV3::setFulltime()
     * @uses DutchBusinessPersonnelInfoV3::setParttime()
     * @uses DutchBusinessPersonnelInfoV3::setTotal()
     * @param int $fulltime
     * @param int $parttime
     * @param int $total
     */
     ...
     * Set fulltime value
     * @param int $fulltime
     * @return \Webservices\StructType\DutchBusinessPersonnelInfoV3
     */
