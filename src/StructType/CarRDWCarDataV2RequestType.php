...
/**
 * This class stands for carRDWCarDataV2RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class CarRDWCarDataV2RequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    /**
     * Constructor method for carRDWCarDataV2RequestType
     * @uses CarRDWCarDataV2RequestType::setLicense_plate()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\CarRDWCarDataV2RequestType
     */
