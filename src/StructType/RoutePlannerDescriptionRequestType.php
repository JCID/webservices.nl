...
/**
 * This class stands for routePlannerDescriptionRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class RoutePlannerDescriptionRequestType extends AbstractStructBase
{
    /**
     * The postcodefrom
     * @var string
    ...
    public $english;
    /**
     * Constructor method for routePlannerDescriptionRequestType
     * @uses RoutePlannerDescriptionRequestType::setPostcodefrom()
     * @uses RoutePlannerDescriptionRequestType::setPostcodeto()
     * @uses RoutePlannerDescriptionRequestType::setEnglish()
     ...
     * @param string $postcodefrom
     * @return \Webservices\StructType\RoutePlannerDescriptionRequestType
     */
