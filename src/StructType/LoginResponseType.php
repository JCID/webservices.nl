...
/**
 * This class stands for loginResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class LoginResponseType extends AbstractStructBase
{
    /**
     * The reactid
     * @var string
    ...
    public $reactid;
    /**
     * Constructor method for loginResponseType
     * @uses LoginResponseType::setReactid()
     ...
     * Set reactid value
     * @param string $reactid
     * @return \Webservices\StructType\LoginResponseType
     */
