...
/**
 * This class stands for userAddGroupRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class UserAddGroupRequestType extends AbstractStructBase
{
    /**
     * The userid
     * @var int
    ...
    public $usergroupid;
    /**
     * Constructor method for userAddGroupRequestType
     * @uses UserAddGroupRequestType::setUserid()
     * @uses UserAddGroupRequestType::setUsergroupid()
     * @param int $userid
     ...
     * Set userid value
     * @param int $userid
     * @return \Webservices\StructType\UserAddGroupRequestType
     */
