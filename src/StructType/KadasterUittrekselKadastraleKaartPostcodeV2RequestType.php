...
/**
 * This class stands for kadasterUittrekselKadastraleKaartPostcodeV2RequestType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterUittrekselKadastraleKaartPostcodeV2RequestType extends AbstractStructBase
{
    /**
     * The postcode
     * @var string
    ...
    public $format;
    /**
     * Constructor method for kadasterUittrekselKadastraleKaartPostcodeV2RequestType
     * @uses KadasterUittrekselKadastraleKaartPostcodeV2RequestType::setPostcode()
     * @uses KadasterUittrekselKadastraleKaartPostcodeV2RequestType::setHuisnummer()
     * @uses KadasterUittrekselKadastraleKaartPostcodeV2RequestType::setHuisnummer_toevoeging()
     * @uses KadasterUittrekselKadastraleKaartPostcodeV2RequestType::setFormat()
     * @param string $postcode
     * @param int $huisnummer
     * @param string $huisnummer_toevoeging
     * @param string $format
     */
    public function __construct($postcode = null, $huisnummer = null, $huisnummer_toevoeging = null, $format = null)
    {
        $this
     ...
     * Set postcode value
     * @param string $postcode
     * @return \Webservices\StructType\KadasterUittrekselKadastraleKaartPostcodeV2RequestType
     */
