...
/**
 * This class stands for kadasterUittrekselKadastraleKaartPostcodeRequestType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterUittrekselKadastraleKaartPostcodeRequestType extends AbstractStructBase
{
    /**
     * The postcode
     * @var string
    ...
    public $format;
    /**
     * Constructor method for kadasterUittrekselKadastraleKaartPostcodeRequestType
     * @uses KadasterUittrekselKadastraleKaartPostcodeRequestType::setPostcode()
     * @uses KadasterUittrekselKadastraleKaartPostcodeRequestType::setHuisnummer()
     * @uses KadasterUittrekselKadastraleKaartPostcodeRequestType::setHuisnummer_toevoeging()
     * @uses KadasterUittrekselKadastraleKaartPostcodeRequestType::setFormat()
     ...
     * Set postcode value
     * @param string $postcode
     * @return \Webservices\StructType\KadasterUittrekselKadastraleKaartPostcodeRequestType
     */
