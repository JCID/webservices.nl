...
/**
 * This class stands for Neighborhood StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class Neighborhood extends AbstractStructBase
{
    /**
     * The nbcode
     * @var string
    ...
    public $nbcode;
    /**
     * Constructor method for Neighborhood
     * @uses Neighborhood::setNbcode()
     * @param string $nbcode
     */
     ...
     * Set nbcode value
     * @param string $nbcode
     * @return \Webservices\StructType\Neighborhood
     */
