...
/**
 * This class stands for kvkGetDossierRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KvkGetDossierRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for kvkGetDossierRequestType
     * @uses KvkGetDossierRequestType::setDossier_number()
     * @uses KvkGetDossierRequestType::setEstablishment_number()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\KvkGetDossierRequestType
     */
