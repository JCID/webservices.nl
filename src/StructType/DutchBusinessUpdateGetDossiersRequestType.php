...
/**
 * This class stands for dutchBusinessUpdateGetDossiersRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessUpdateGetDossiersRequestType extends AbstractStructBase
{
    /**
     * The update_types
    ...
    public $page;
    /**
     * Constructor method for dutchBusinessUpdateGetDossiersRequestType
     * @uses DutchBusinessUpdateGetDossiersRequestType::setUpdate_types()
     * @uses DutchBusinessUpdateGetDossiersRequestType::setPage()
     ...
     * @param \Webservices\ArrayType\StringArray $update_types
     * @return \Webservices\StructType\DutchBusinessUpdateGetDossiersRequestType
     */
