...
/**
 * This class stands for dutchBusinessSearchEstablishmentsResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessSearchEstablishmentsResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for dutchBusinessSearchEstablishmentsResponseType
     * @uses DutchBusinessSearchEstablishmentsResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\DutchBusinessEstablishmentReferencePagedResult $out
     * @return \Webservices\StructType\DutchBusinessSearchEstablishmentsResponseType
     */
