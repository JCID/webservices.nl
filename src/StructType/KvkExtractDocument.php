...
/**
 * This class stands for KvkExtractDocument StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KvkExtractDocument extends AbstractStructBase
{
    /**
     * The document
     * @var string
    ...
    /**
     * Constructor method for KvkExtractDocument
     * @uses KvkExtractDocument::setDocument()
     * @uses KvkExtractDocument::setDocument_date()
     ...
     * Set document value
     * @param string $document
     * @return \Webservices\StructType\KvkExtractDocument
     */
