...
/**
 * This class stands for kadasterV2GetKoopsommenOverzichtRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterV2GetKoopsommenOverzichtRequestType extends AbstractStructBase
{
    /**
     * The postcode
     * @var string
    ...
    public $huisletter;
    /**
     * Constructor method for kadasterV2GetKoopsommenOverzichtRequestType
     * @uses KadasterV2GetKoopsommenOverzichtRequestType::setPostcode()
     * @uses KadasterV2GetKoopsommenOverzichtRequestType::setHuisnummer()
     * @uses KadasterV2GetKoopsommenOverzichtRequestType::setHuisnummer_toevoeging()
     * @uses KadasterV2GetKoopsommenOverzichtRequestType::setDocument()
     * @uses KadasterV2GetKoopsommenOverzichtRequestType::setHuisletter()
     ...
     * Set postcode value
     * @param string $postcode
     * @return \Webservices\StructType\KadasterV2GetKoopsommenOverzichtRequestType
     */
