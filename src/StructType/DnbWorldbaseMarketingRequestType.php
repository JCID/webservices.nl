...
/**
 * This class stands for dnbWorldbaseMarketingRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DnbWorldbaseMarketingRequestType extends AbstractStructBase
{
    /**
     * The company_id
     * @var string
    ...
    /**
     * Constructor method for dnbWorldbaseMarketingRequestType
     * @uses DnbWorldbaseMarketingRequestType::setCompany_id()
     * @uses DnbWorldbaseMarketingRequestType::setCompany_id_type()
     ...
     * @param string $company_id
     * @return \Webservices\StructType\DnbWorldbaseMarketingRequestType
     */
