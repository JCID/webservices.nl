...
/**
 * This class stands for BerichtObject StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BerichtObject extends AbstractStructBase
{
    /**
    ...
    /**
     * The personen
     * @var \Webservices\ArrayType\PersoonArray
     */
    public $personen;
    /**
     * The stukken
    ...
    public $document;
    /**
     * Constructor method for BerichtObject
     * @uses BerichtObject::setDatum_bijgewerkt()
     * @uses BerichtObject::setOnroerende_zaak()
     * @uses BerichtObject::setRechten_lijst()
     * @uses BerichtObject::setPersonen()
     * @uses BerichtObject::setStukken()
     * @uses BerichtObject::setGemeentestukken()
     * @uses BerichtObject::setDocument()
     ...
     * @param \Webservices\ArrayType\PersoonArray $personen
     * @param \Webservices\ArrayType\StukArray $stukken
     * @param \Webservices\ArrayType\GemeenteStukArray $gemeentestukken
     * @param string $document
     */
    public function __construct($datum_bijgewerkt = null, \Webservices\StructType\OnroerendeZaak $onroerende_zaak = null, \Webservices\StructType\RechtenLijst $rechten_lijst = null, \Webservices\ArrayType\PersoonArray $personen = null, \Webservices\ArrayType\StukArray $stukken = null, \Webservices\ArrayType\GemeenteStukArray $gemeentestukken = null, $document = null)
    {
        $this
     ...
     * @param string $datum_bijgewerkt
     * @return \Webservices\StructType\BerichtObject
     */
    ...
    /**
     * Get personen value
     * @return \Webservices\ArrayType\PersoonArray|null
     */
     ...
     * @return \Webservices\StructType\BerichtObject
     */
    public function setPersonen(\Webservices\ArrayType\PersoonArray $personen = null)
    {
