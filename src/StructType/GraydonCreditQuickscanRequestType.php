...
/**
 * This class stands for graydonCreditQuickscanRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class GraydonCreditQuickscanRequestType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for graydonCreditQuickscanRequestType
     * @uses GraydonCreditQuickscanRequestType::setGraydon_company_id()
     ...
     * @param int $graydon_company_id
     * @return \Webservices\StructType\GraydonCreditQuickscanRequestType
     */
