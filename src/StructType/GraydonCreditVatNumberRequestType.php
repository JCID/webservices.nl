...
/**
 * This class stands for graydonCreditVatNumberRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class GraydonCreditVatNumberRequestType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for graydonCreditVatNumberRequestType
     * @uses GraydonCreditVatNumberRequestType::setGraydon_company_id()
     ...
     * @param int $graydon_company_id
     * @return \Webservices\StructType\GraydonCreditVatNumberRequestType
     */
