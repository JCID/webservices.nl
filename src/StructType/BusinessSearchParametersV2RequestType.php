...
/**
 * This class stands for businessSearchParametersV2RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BusinessSearchParametersV2RequestType extends AbstractStructBase
{
    /**
     * The tradename
     * @var string
    ...
    public $page;
    /**
     * Constructor method for businessSearchParametersV2RequestType
     * @uses BusinessSearchParametersV2RequestType::setTradename()
     * @uses BusinessSearchParametersV2RequestType::setCityname()
     * @uses BusinessSearchParametersV2RequestType::setStreetname()
     * @uses BusinessSearchParametersV2RequestType::setPostcode()
     * @uses BusinessSearchParametersV2RequestType::setHouseno()
     * @uses BusinessSearchParametersV2RequestType::setHousenoaddition()
     * @uses BusinessSearchParametersV2RequestType::setTelephoneno()
     * @uses BusinessSearchParametersV2RequestType::setPage()
     ...
     * Set tradename value
     * @param string $tradename
     * @return \Webservices\StructType\BusinessSearchParametersV2RequestType
     */
