...
/**
 * This class stands for AccountV2 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class AccountV2 extends AbstractStructBase
{
    /**
     * The id
     * @var int
    ...
    /**
     * Constructor method for AccountV2
     * @uses AccountV2::setId()
     * @uses AccountV2::setName()
     * @uses AccountV2::setAddress()
     * @uses AccountV2::setEnvironment()
     * @uses AccountV2::setReseller()
     * @uses AccountV2::setContactname()
     * @uses AccountV2::setContactemail()
     * @uses AccountV2::setTelephone()
     * @uses AccountV2::setFax()
     * @uses AccountV2::setDescription()
     * @uses AccountV2::setCreationtime()
     * @uses AccountV2::setLastmodified()
     * @uses AccountV2::setClientcode()
     * @uses AccountV2::setComments()
     * @uses AccountV2::setUsernameprefix()
     * @uses AccountV2::setBalance()
     * @uses AccountV2::setBalancethreshold()
     * @param int $id
     * @param string $name
     ...
     */
    public function __construct($id = null, $name = null, $address = null, $environment = null, $reseller = null, $contactname = null, $contactemail = null, $telephone = null, $fax = null, $description = null, $creationtime = null, $lastmodified = null, $clientcode = null, $comments = null, $usernameprefix = null, $balance = null, $balancethreshold = null)
    {
        $this
            ->setId($id)
            ->setName($name)
     ...
     * Set id value
     * @param int $id
     * @return \Webservices\StructType\AccountV2
     */
