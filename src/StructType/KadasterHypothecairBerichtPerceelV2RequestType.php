...
/**
 * This class stands for kadasterHypothecairBerichtPerceelV2RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterHypothecairBerichtPerceelV2RequestType extends AbstractStructBase
{
    /**
     * The gemeentecode
     * @var string
    ...
    public $format;
    /**
     * Constructor method for kadasterHypothecairBerichtPerceelV2RequestType
     * @uses KadasterHypothecairBerichtPerceelV2RequestType::setGemeentecode()
     * @uses KadasterHypothecairBerichtPerceelV2RequestType::setGemeentenaam()
     * @uses KadasterHypothecairBerichtPerceelV2RequestType::setSectie()
     * @uses KadasterHypothecairBerichtPerceelV2RequestType::setPerceelnummer()
     * @uses KadasterHypothecairBerichtPerceelV2RequestType::setRelatiecode()
     * @uses KadasterHypothecairBerichtPerceelV2RequestType::setVolgnummer()
     * @uses KadasterHypothecairBerichtPerceelV2RequestType::setFormat()
     ...
     * @param string $gemeentecode
     * @return \Webservices\StructType\KadasterHypothecairBerichtPerceelV2RequestType
     */
