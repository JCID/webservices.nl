...
/**
 * This class stands for kadasterHypothecairBerichtPostcodeV3RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterHypothecairBerichtPostcodeV3RequestType extends AbstractStructBase
{
    /**
     * The postcode
     * @var string
    ...
    public $format;
    /**
     * Constructor method for kadasterHypothecairBerichtPostcodeV3RequestType
     * @uses KadasterHypothecairBerichtPostcodeV3RequestType::setPostcode()
     * @uses KadasterHypothecairBerichtPostcodeV3RequestType::setHuisnummer()
     * @uses KadasterHypothecairBerichtPostcodeV3RequestType::setHuisnummer_toevoeging()
     * @uses KadasterHypothecairBerichtPostcodeV3RequestType::setFormat()
     ...
     * Set postcode value
     * @param string $postcode
     * @return \Webservices\StructType\KadasterHypothecairBerichtPostcodeV3RequestType
     */
