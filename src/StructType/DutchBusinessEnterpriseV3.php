...
/**
 * This class stands for DutchBusinessEnterpriseV3 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessEnterpriseV3 extends AbstractStructBase
{
    /**
     * The name
    ...
    public $trade_names;
    /**
     * Constructor method for DutchBusinessEnterpriseV3
     * @uses DutchBusinessEnterpriseV3::setName()
     * @uses DutchBusinessEnterpriseV3::setRegistration()
     * @uses DutchBusinessEnterpriseV3::setLegal_form_text()
     * @uses DutchBusinessEnterpriseV3::setActivity()
     * @uses DutchBusinessEnterpriseV3::setDescription()
     * @uses DutchBusinessEnterpriseV3::setIncorporation_date()
     * @uses DutchBusinessEnterpriseV3::setFounding_date()
     * @uses DutchBusinessEnterpriseV3::setDiscontinuation_date()
     * @uses DutchBusinessEnterpriseV3::setDate_since()
     * @uses DutchBusinessEnterpriseV3::setPersonnel()
     * @uses DutchBusinessEnterpriseV3::setRemarks()
     * @uses DutchBusinessEnterpriseV3::setSbi_codes()
     * @uses DutchBusinessEnterpriseV3::setTrade_names()
     * @param string $name
     * @param string $registration
     * @param string $legal_form_text
     * @param string $activity
     * @param string $description
     * @param \Webservices\StructType\DutchBusinessDateV3 $incorporation_date
     ...
     */
    public function __construct($name = null, $registration = null, $legal_form_text = null, $activity = null, $description = null, \Webservices\StructType\DutchBusinessDateV3 $incorporation_date = null, \Webservices\StructType\DutchBusinessDateV3 $founding_date = null, \Webservices\StructType\DutchBusinessDateV3 $discontinuation_date = null, \Webservices\StructType\DutchBusinessDateV3 $date_since = null, \Webservices\StructType\DutchBusinessPersonnelInfoV3 $personnel = null, \Webservices\ArrayType\StringArray $remarks = null, \Webservices\ArrayType\DutchBusinessSbiCodeV3Array $sbi_codes = null, \Webservices\ArrayType\StringArray $trade_names = null)
    {
        $this
            ->setName($name)
     ...
     * Set name value
     * @param string $name
     * @return \Webservices\StructType\DutchBusinessEnterpriseV3
     */
     ...
     * @return \Webservices\StructType\DutchBusinessEnterpriseV3
     */
    public function setIncorporation_date(\Webservices\StructType\DutchBusinessDateV3 $incorporation_date = null)
    {
