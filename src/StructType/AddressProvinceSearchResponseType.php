...
/**
 * This class stands for addressProvinceSearchResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class AddressProvinceSearchResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for addressProvinceSearchResponseType
     * @uses AddressProvinceSearchResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\ProvincePagedResult $out
     * @return \Webservices\StructType\AddressProvinceSearchResponseType
     */
