...
/**
 * This class stands for graydonCreditManagementRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class GraydonCreditManagementRequestType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for graydonCreditManagementRequestType
     * @uses GraydonCreditManagementRequestType::setGraydon_company_id()
     ...
     * @param int $graydon_company_id
     * @return \Webservices\StructType\GraydonCreditManagementRequestType
     */
