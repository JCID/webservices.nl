...
/**
 * This class stands for carVWEBasicTypeDataRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class CarVWEBasicTypeDataRequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    /**
     * Constructor method for carVWEBasicTypeDataRequestType
     * @uses CarVWEBasicTypeDataRequestType::setLicense_plate()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\CarVWEBasicTypeDataRequestType
     */
