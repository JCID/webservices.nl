...
/**
 * This class stands for addressPerceelPhraseSearchResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class AddressPerceelPhraseSearchResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for addressPerceelPhraseSearchResponseType
     * @uses AddressPerceelPhraseSearchResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\PerceelSearchPartsPagedResult $out
     * @return \Webservices\StructType\AddressPerceelPhraseSearchResponseType
     */
