...
/**
 * This class stands for kadasterHypothecairBerichtPerceelV3RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterHypothecairBerichtPerceelV3RequestType extends AbstractStructBase
{
    /**
     * The gemeentecode
     * @var string
    ...
    public $format;
    /**
     * Constructor method for kadasterHypothecairBerichtPerceelV3RequestType
     * @uses KadasterHypothecairBerichtPerceelV3RequestType::setGemeentecode()
     * @uses KadasterHypothecairBerichtPerceelV3RequestType::setGemeentenaam()
     * @uses KadasterHypothecairBerichtPerceelV3RequestType::setSectie()
     * @uses KadasterHypothecairBerichtPerceelV3RequestType::setPerceelnummer()
     * @uses KadasterHypothecairBerichtPerceelV3RequestType::setRelatiecode()
     * @uses KadasterHypothecairBerichtPerceelV3RequestType::setVolgnummer()
     * @uses KadasterHypothecairBerichtPerceelV3RequestType::setFormat()
     ...
     * @param string $gemeentecode
     * @return \Webservices\StructType\KadasterHypothecairBerichtPerceelV3RequestType
     */
