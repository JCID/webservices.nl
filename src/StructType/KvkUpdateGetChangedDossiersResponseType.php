...
/**
 * This class stands for kvkUpdateGetChangedDossiersResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KvkUpdateGetChangedDossiersResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for kvkUpdateGetChangedDossiersResponseType
     * @uses KvkUpdateGetChangedDossiersResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\KvkUpdateReferencePagedResult $out
     * @return \Webservices\StructType\KvkUpdateGetChangedDossiersResponseType
     */
