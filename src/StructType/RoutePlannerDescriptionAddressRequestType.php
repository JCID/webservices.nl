...
/**
 * This class stands for routePlannerDescriptionAddressRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class RoutePlannerDescriptionAddressRequestType extends AbstractStructBase
{
    /**
     * The routetype
     * @var string
    ...
    public $language;
    /**
     * Constructor method for routePlannerDescriptionAddressRequestType
     * @uses RoutePlannerDescriptionAddressRequestType::setRoutetype()
     * @uses RoutePlannerDescriptionAddressRequestType::setFrom_postalcode()
     * @uses RoutePlannerDescriptionAddressRequestType::setFrom_houseno()
     * @uses RoutePlannerDescriptionAddressRequestType::setFrom_street()
     * @uses RoutePlannerDescriptionAddressRequestType::setFrom_city()
     * @uses RoutePlannerDescriptionAddressRequestType::setFrom_country()
     * @uses RoutePlannerDescriptionAddressRequestType::setTo_postalcode()
     * @uses RoutePlannerDescriptionAddressRequestType::setTo_houseno()
     * @uses RoutePlannerDescriptionAddressRequestType::setTo_street()
     * @uses RoutePlannerDescriptionAddressRequestType::setTo_city()
     * @uses RoutePlannerDescriptionAddressRequestType::setTo_country()
     * @uses RoutePlannerDescriptionAddressRequestType::setLanguage()
     ...
     */
    public function __construct($routetype = null, $from_postalcode = null, $from_houseno = null, $from_street = null, $from_city = null, $from_country = null, $to_postalcode = null, $to_houseno = null, $to_street = null, $to_city = null, $to_country = null, $language = null)
    {
        $this
     ...
     * Set routetype value
     * @param string $routetype
     * @return \Webservices\StructType\RoutePlannerDescriptionAddressRequestType
     */
