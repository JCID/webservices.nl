...
/**
 * This class stands for kvkUpdateGetChangedDossiersRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KvkUpdateGetChangedDossiersRequestType extends AbstractStructBase
{
    /**
     * The changed_since
     * @var string
    ...
    public $page;
    /**
     * Constructor method for kvkUpdateGetChangedDossiersRequestType
     * @uses KvkUpdateGetChangedDossiersRequestType::setChanged_since()
     * @uses KvkUpdateGetChangedDossiersRequestType::setUpdate_types()
     * @uses KvkUpdateGetChangedDossiersRequestType::setPage()
     ...
     * @param string $changed_since
     * @return \Webservices\StructType\KvkUpdateGetChangedDossiersRequestType
     */
