...
/**
 * This class stands for KadasterV2IsGebaseerdOp StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterV2IsGebaseerdOp extends AbstractStructBase
{
    /**
     * The stukdeel
    ...
    public $stukdeel;
    /**
     * Constructor method for KadasterV2IsGebaseerdOp
     * @uses KadasterV2IsGebaseerdOp::setStukdeel()
     ...
     * Set stukdeel value
     * @param \Webservices\ArrayType\KadasterV2StukdeelArray $stukdeel
     * @return \Webservices\StructType\KadasterV2IsGebaseerdOp
     */
