...
/**
 * This class stands for kvkSearchPostcodeResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KvkSearchPostcodeResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for kvkSearchPostcodeResponseType
     * @uses KvkSearchPostcodeResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\KvkReferencePagedResult $out
     * @return \Webservices\StructType\KvkSearchPostcodeResponseType
     */
