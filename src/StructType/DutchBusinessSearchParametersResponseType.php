...
/**
 * This class stands for dutchBusinessSearchParametersResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessSearchParametersResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for dutchBusinessSearchParametersResponseType
     * @uses DutchBusinessSearchParametersResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\DutchBusinessReferencePagedResult $out
     * @return \Webservices\StructType\DutchBusinessSearchParametersResponseType
     */
