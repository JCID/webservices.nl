...
/**
 * This class stands for routePlannerRDDescriptionRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class RoutePlannerRDDescriptionRequestType extends AbstractStructBase
{
    /**
     * The xfrom
     * @var int
    ...
    public $english;
    /**
     * Constructor method for routePlannerRDDescriptionRequestType
     * @uses RoutePlannerRDDescriptionRequestType::setXfrom()
     * @uses RoutePlannerRDDescriptionRequestType::setYfrom()
     * @uses RoutePlannerRDDescriptionRequestType::setXto()
     * @uses RoutePlannerRDDescriptionRequestType::setYto()
     * @uses RoutePlannerRDDescriptionRequestType::setRoutetype()
     * @uses RoutePlannerRDDescriptionRequestType::setEnglish()
     * @param int $xfrom
     * @param int $yfrom
     * @param int $xto
     * @param int $yto
     ...
     * Set xfrom value
     * @param int $xfrom
     * @return \Webservices\StructType\RoutePlannerRDDescriptionRequestType
     */
