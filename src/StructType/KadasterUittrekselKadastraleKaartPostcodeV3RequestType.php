...
/**
 * This class stands for kadasterUittrekselKadastraleKaartPostcodeV3RequestType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterUittrekselKadastraleKaartPostcodeV3RequestType extends AbstractStructBase
{
    /**
     * The postcode
     * @var string
    ...
    public $format;
    /**
     * Constructor method for kadasterUittrekselKadastraleKaartPostcodeV3RequestType
     * @uses KadasterUittrekselKadastraleKaartPostcodeV3RequestType::setPostcode()
     * @uses KadasterUittrekselKadastraleKaartPostcodeV3RequestType::setHuisnummer()
     * @uses KadasterUittrekselKadastraleKaartPostcodeV3RequestType::setHuisnummer_toevoeging()
     * @uses KadasterUittrekselKadastraleKaartPostcodeV3RequestType::setFormat()
     ...
     * Set postcode value
     * @param string $postcode
     * @return \Webservices\StructType\KadasterUittrekselKadastraleKaartPostcodeV3RequestType
     */
