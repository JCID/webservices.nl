...
/**
 * This class stands for businessGetDossierExtendedRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BusinessGetDossierExtendedRequestType extends AbstractStructBase
{
    /**
     * The dossierno
     * @var string
    ...
    public $subdossierno;
    /**
     * Constructor method for businessGetDossierExtendedRequestType
     * @uses BusinessGetDossierExtendedRequestType::setDossierno()
     * @uses BusinessGetDossierExtendedRequestType::setSubdossierno()
     ...
     * Set dossierno value
     * @param string $dossierno
     * @return \Webservices\StructType\BusinessGetDossierExtendedRequestType
     */
