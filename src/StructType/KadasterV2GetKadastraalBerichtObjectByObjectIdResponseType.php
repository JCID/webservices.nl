...
/**
 * This class stands for kadasterV2GetKadastraalBerichtObjectByObjectIdResponseType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterV2GetKadastraalBerichtObjectByObjectIdResponseType extends AbstractStructBase
{
    /**
     * The resultaat
     ...
     * kadasterV2GetKadastraalBerichtObjectByObjectIdResponseType
     * @uses KadasterV2GetKadastraalBerichtObjectByObjectIdResponseType::setResultaat()
     ...
     * Set resultaat value
     * @param \Webservices\StructType\KadasterV2KadastraalBerichtObjectResponse $resultaat
     * @return \Webservices\StructType\KadasterV2GetKadastraalBerichtObjectByObjectIdResponseType
     */
