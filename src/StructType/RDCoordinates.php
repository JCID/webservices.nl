...
/**
 * This class stands for RDCoordinates StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class RDCoordinates extends AbstractStructBase
{
    /**
     * The x
     * @var int
    ...
    public $y;
    /**
     * Constructor method for RDCoordinates
     * @uses RDCoordinates::setX()
     * @uses RDCoordinates::setY()
     * @param int $x
     * @param int $y
     */
     ...
     * Set x value
     * @param int $x
     * @return \Webservices\StructType\RDCoordinates
     */
