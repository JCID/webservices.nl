...
/**
 * This class stands for businessUpdateAddDossierRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BusinessUpdateAddDossierRequestType extends AbstractStructBase
{
    /**
     * The dossierno
     * @var string
    ...
    public $subdossierno;
    /**
     * Constructor method for businessUpdateAddDossierRequestType
     * @uses BusinessUpdateAddDossierRequestType::setDossierno()
     * @uses BusinessUpdateAddDossierRequestType::setSubdossierno()
     ...
     * Set dossierno value
     * @param string $dossierno
     * @return \Webservices\StructType\BusinessUpdateAddDossierRequestType
     */
