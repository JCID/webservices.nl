...
/**
 * This class stands for dutchBusinessGetExtractDocumentDataRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessGetExtractDocumentDataRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for dutchBusinessGetExtractDocumentDataRequestType
     * @uses DutchBusinessGetExtractDocumentDataRequestType::setDossier_number()
     * @uses DutchBusinessGetExtractDocumentDataRequestType::setAllow_caching()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessGetExtractDocumentDataRequestType
     */
