...
/**
 * This class stands for dutchBusinessGetExtractDocumentDataV2ResponseType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessGetExtractDocumentDataV2ResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for dutchBusinessGetExtractDocumentDataV2ResponseType
     * @uses DutchBusinessGetExtractDocumentDataV2ResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\DutchBusinessExtractDocumentDataV2 $out
     * @return \Webservices\StructType\DutchBusinessGetExtractDocumentDataV2ResponseType
     */
