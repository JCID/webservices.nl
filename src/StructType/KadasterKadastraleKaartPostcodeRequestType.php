...
/**
 * This class stands for kadasterKadastraleKaartPostcodeRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterKadastraleKaartPostcodeRequestType extends AbstractStructBase
{
    /**
     * The postcode
     * @var string
    ...
    public $schaal;
    /**
     * Constructor method for kadasterKadastraleKaartPostcodeRequestType
     * @uses KadasterKadastraleKaartPostcodeRequestType::setPostcode()
     * @uses KadasterKadastraleKaartPostcodeRequestType::setHuisnummer()
     * @uses KadasterKadastraleKaartPostcodeRequestType::setHuisnummer_toevoeging()
     * @uses KadasterKadastraleKaartPostcodeRequestType::setFormat()
     * @uses KadasterKadastraleKaartPostcodeRequestType::setSchaal()
     ...
     * Set postcode value
     * @param string $postcode
     * @return \Webservices\StructType\KadasterKadastraleKaartPostcodeRequestType
     */
