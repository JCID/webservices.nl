...
/**
 * This class stands for KadasterUittrekselKadastraleKaartResultaat StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterUittrekselKadastraleKaartResultaat extends AbstractStructBase
{
    /**
     * The overzicht
    ...
    /**
     * Constructor method for KadasterUittrekselKadastraleKaartResultaat
     * @uses KadasterUittrekselKadastraleKaartResultaat::setOverzicht()
     * @uses KadasterUittrekselKadastraleKaartResultaat::setKadastrale_kaart()
     ...
     */
    public function __construct(\Webservices\StructType\KadasterOverzicht $overzicht = null, \Webservices\StructType\KadasterUittrekselKadastraleKaartV2 $kadastrale_kaart = null)
    {
        $this
     ...
     * Set overzicht value
     * @param \Webservices\StructType\KadasterOverzicht $overzicht
     * @return \Webservices\StructType\KadasterUittrekselKadastraleKaartResultaat
     */
