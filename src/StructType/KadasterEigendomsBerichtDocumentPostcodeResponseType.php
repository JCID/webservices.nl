...
/**
 * This class stands for kadasterEigendomsBerichtDocumentPostcodeResponseType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterEigendomsBerichtDocumentPostcodeResponseType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for kadasterEigendomsBerichtDocumentPostcodeResponseType
     * @uses KadasterEigendomsBerichtDocumentPostcodeResponseType::setBerichtobjectresultaat()
     ...
     * @param \Webservices\StructType\BerichtObjectDocumentResultaat $berichtobjectresultaat
     * @return \Webservices\StructType\KadasterEigendomsBerichtDocumentPostcodeResponseType
     */
