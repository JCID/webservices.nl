...
/**
 * This class stands for dutchBusinessSearchParametersRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessSearchParametersRequestType extends AbstractStructBase
{
    /**
     * The trade_name
     * @var string
    ...
    public $page;
    /**
     * Constructor method for dutchBusinessSearchParametersRequestType
     * @uses DutchBusinessSearchParametersRequestType::setTrade_name()
     * @uses DutchBusinessSearchParametersRequestType::setCity()
     * @uses DutchBusinessSearchParametersRequestType::setStreet()
     * @uses DutchBusinessSearchParametersRequestType::setPostcode()
     * @uses DutchBusinessSearchParametersRequestType::setHouse_number()
     * @uses DutchBusinessSearchParametersRequestType::setHouse_number_addition()
     * @uses DutchBusinessSearchParametersRequestType::setTelephone_number()
     * @uses DutchBusinessSearchParametersRequestType::setDomain_name()
     * @uses DutchBusinessSearchParametersRequestType::setStrict_search()
     * @uses DutchBusinessSearchParametersRequestType::setPage()
     ...
     * @param string $trade_name
     * @return \Webservices\StructType\DutchBusinessSearchParametersRequestType
     */
