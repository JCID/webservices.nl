...
/**
 * This class stands for kvkSearchParametersResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KvkSearchParametersResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for kvkSearchParametersResponseType
     * @uses KvkSearchParametersResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\KvkReferencePagedResult $out
     * @return \Webservices\StructType\KvkSearchParametersResponseType
     */
