...
/**
 * This class stands for dutchVehicleGetMarketValueRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchVehicleGetMarketValueRequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    /**
     * Constructor method for dutchVehicleGetMarketValueRequestType
     * @uses DutchVehicleGetMarketValueRequestType::setLicense_plate()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\DutchVehicleGetMarketValueRequestType
     */
