...
/**
 * This class stands for carRDWCarDataBPV2RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class CarRDWCarDataBPV2RequestType extends AbstractStructBase
{
    /**
     * The license_plate
     * @var string
    ...
    /**
     * Constructor method for carRDWCarDataBPV2RequestType
     * @uses CarRDWCarDataBPV2RequestType::setLicense_plate()
     ...
     * @param string $license_plate
     * @return \Webservices\StructType\CarRDWCarDataBPV2RequestType
     */
