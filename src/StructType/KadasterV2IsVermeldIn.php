...
/**
 * This class stands for KadasterV2IsVermeldIn StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterV2IsVermeldIn extends AbstractStructBase
{
    /**
     * The stukdeel
    ...
    public $stukdeel;
    /**
     * Constructor method for KadasterV2IsVermeldIn
     * @uses KadasterV2IsVermeldIn::setStukdeel()
     ...
     * Set stukdeel value
     * @param \Webservices\ArrayType\KadasterV2StukdeelArray $stukdeel
     * @return \Webservices\StructType\KadasterV2IsVermeldIn
     */
