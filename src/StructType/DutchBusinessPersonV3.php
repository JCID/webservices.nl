...
/**
 * This class stands for DutchBusinessPersonV3 StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessPersonV3 extends AbstractStructBase
{
    /**
     * The full_name
    ...
    /**
     * Constructor method for DutchBusinessPersonV3
     * @uses DutchBusinessPersonV3::setFull_name()
     * @uses DutchBusinessPersonV3::setFirst_name()
     * @uses DutchBusinessPersonV3::setTitle()
     * @uses DutchBusinessPersonV3::setInitials()
     * @uses DutchBusinessPersonV3::setLast_name()
     * @uses DutchBusinessPersonV3::setGender()
     * @uses DutchBusinessPersonV3::setDate_deceased()
     * @uses DutchBusinessPersonV3::setDate_of_birth()
     * @uses DutchBusinessPersonV3::setPlace_of_birth()
     * @uses DutchBusinessPersonV3::setCountry_of_birth()
     ...
     * @param string $gender
     * @param \Webservices\StructType\DutchBusinessDateV3 $date_deceased
     * @param \Webservices\StructType\DutchBusinessDateV3 $date_of_birth
     * @param string $place_of_birth
     * @param string $country_of_birth
     */
    public function __construct($full_name = null, $first_name = null, $title = null, $initials = null, $last_name = null, $gender = null, \Webservices\StructType\DutchBusinessDateV3 $date_deceased = null, \Webservices\StructType\DutchBusinessDateV3 $date_of_birth = null, $place_of_birth = null, $country_of_birth = null)
    {
        $this
     ...
     * Set full_name value
     * @param string $full_name
     * @return \Webservices\StructType\DutchBusinessPersonV3
     */
     ...
     * @return \Webservices\StructType\DutchBusinessPersonV3
     */
    public function setDate_deceased(\Webservices\StructType\DutchBusinessDateV3 $date_deceased = null)
    {
     ...
     * @return \Webservices\StructType\DutchBusinessPersonV3
     */
    public function setDate_of_birth(\Webservices\StructType\DutchBusinessDateV3 $date_of_birth = null)
    {
