...
/**
 * This class stands for dnbWorldbaseMarketingPlusLinkageRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DnbWorldbaseMarketingPlusLinkageRequestType extends AbstractStructBase
{
    /**
     * The company_id
     * @var string
    ...
    /**
     * Constructor method for dnbWorldbaseMarketingPlusLinkageRequestType
     * @uses DnbWorldbaseMarketingPlusLinkageRequestType::setCompany_id()
     * @uses DnbWorldbaseMarketingPlusLinkageRequestType::setCompany_id_type()
     ...
     * @param string $company_id
     * @return \Webservices\StructType\DnbWorldbaseMarketingPlusLinkageRequestType
     */
