...
/**
 * This class stands for dutchBusinessGetDossierV3RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessGetDossierV3RequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for dutchBusinessGetDossierV3RequestType
     * @uses DutchBusinessGetDossierV3RequestType::setDossier_number()
     * @uses DutchBusinessGetDossierV3RequestType::setEstablishment_number()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessGetDossierV3RequestType
     */
