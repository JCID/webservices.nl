...
/**
 * This class stands for kadasterUittrekselKadastraleKaartPerceelV2RequestType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterUittrekselKadastraleKaartPerceelV2RequestType extends AbstractStructBase
{
    /**
     * The gemeentecode
     * @var string
    ...
    public $format;
    /**
     * Constructor method for kadasterUittrekselKadastraleKaartPerceelV2RequestType
     * @uses KadasterUittrekselKadastraleKaartPerceelV2RequestType::setGemeentecode()
     * @uses KadasterUittrekselKadastraleKaartPerceelV2RequestType::setGemeentenaam()
     * @uses KadasterUittrekselKadastraleKaartPerceelV2RequestType::setSectie()
     * @uses KadasterUittrekselKadastraleKaartPerceelV2RequestType::setPerceelnummer()
     * @uses KadasterUittrekselKadastraleKaartPerceelV2RequestType::setRelatiecode()
     * @uses KadasterUittrekselKadastraleKaartPerceelV2RequestType::setVolgnummer()
     * @uses KadasterUittrekselKadastraleKaartPerceelV2RequestType::setFormat()
     ...
     * @param string $gemeentecode
     * @return \Webservices\StructType\KadasterUittrekselKadastraleKaartPerceelV2RequestType
     */
