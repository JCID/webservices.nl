...
/**
 * This class stands for dutchBusinessSearchParametersV2RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessSearchParametersV2RequestType extends AbstractStructBase
{
    /**
     * The trade_name
     * @var string
    ...
    public $page;
    /**
     * Constructor method for dutchBusinessSearchParametersV2RequestType
     * @uses DutchBusinessSearchParametersV2RequestType::setTrade_name()
     * @uses DutchBusinessSearchParametersV2RequestType::setCity()
     * @uses DutchBusinessSearchParametersV2RequestType::setStreet()
     * @uses DutchBusinessSearchParametersV2RequestType::setPostcode()
     * @uses DutchBusinessSearchParametersV2RequestType::setHouse_number()
     * @uses DutchBusinessSearchParametersV2RequestType::setHouse_number_addition()
     * @uses DutchBusinessSearchParametersV2RequestType::setTelephone_number()
     * @uses DutchBusinessSearchParametersV2RequestType::setDomain_name()
     * @uses DutchBusinessSearchParametersV2RequestType::setStrict_search()
     * @uses DutchBusinessSearchParametersV2RequestType::setPage()
     ...
     * @param string $trade_name
     * @return \Webservices\StructType\DutchBusinessSearchParametersV2RequestType
     */
