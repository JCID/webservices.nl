...
/**
 * This class stands for dutchBusinessGetDossierRequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessGetDossierRequestType extends AbstractStructBase
{
    /**
     * The dossier_number
     * @var string
    ...
    /**
     * Constructor method for dutchBusinessGetDossierRequestType
     * @uses DutchBusinessGetDossierRequestType::setDossier_number()
     * @uses DutchBusinessGetDossierRequestType::setEstablishment_number()
     ...
     * @param string $dossier_number
     * @return \Webservices\StructType\DutchBusinessGetDossierRequestType
     */
