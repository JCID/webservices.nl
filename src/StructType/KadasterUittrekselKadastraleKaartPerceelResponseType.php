...
/**
 * This class stands for kadasterUittrekselKadastraleKaartPerceelResponseType
 * StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterUittrekselKadastraleKaartPerceelResponseType extends AbstractStructBase
{
    /**
     * The uittreksel
    ...
    public $uittreksel;
    /**
     * Constructor method for kadasterUittrekselKadastraleKaartPerceelResponseType
     * @uses KadasterUittrekselKadastraleKaartPerceelResponseType::setUittreksel()
     ...
     * @param \Webservices\StructType\UittrekselKadastraleKaart $uittreksel
     * @return \Webservices\StructType\KadasterUittrekselKadastraleKaartPerceelResponseType
     */
