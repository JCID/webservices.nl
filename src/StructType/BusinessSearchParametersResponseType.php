...
/**
 * This class stands for businessSearchParametersResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BusinessSearchParametersResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for businessSearchParametersResponseType
     * @uses BusinessSearchParametersResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\BusinessReferencePagedResult $out
     * @return \Webservices\StructType\BusinessSearchParametersResponseType
     */
