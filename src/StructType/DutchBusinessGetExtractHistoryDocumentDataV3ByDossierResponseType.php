 ...
 * dutchBusinessGetExtractHistoryDocumentDataV3ByDossierResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class DutchBusinessGetExtractHistoryDocumentDataV3ByDossierResponseType extends AbstractStructBase
{
    /**
     * The out
     ...
     * @uses DutchBusinessGetExtractHistoryDocumentDataV3ByDossierResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\DutchBusinessExtractDocumentDataV3 $out
     * @return \Webservices\StructType\DutchBusinessGetExtractHistoryDocumentDataV3ByDossierResponseType
     */
