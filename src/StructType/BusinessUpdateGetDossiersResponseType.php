...
/**
 * This class stands for businessUpdateGetDossiersResponseType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class BusinessUpdateGetDossiersResponseType extends AbstractStructBase
{
    /**
     * The out
    ...
    public $out;
    /**
     * Constructor method for businessUpdateGetDossiersResponseType
     * @uses BusinessUpdateGetDossiersResponseType::setOut()
     ...
     * Set out value
     * @param \Webservices\StructType\BusinessUpdateReferencePagedResult $out
     * @return \Webservices\StructType\BusinessUpdateGetDossiersResponseType
     */
