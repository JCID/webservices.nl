...
/**
 * This class stands for kadasterHypothecairBerichtPostcodeV2RequestType StructType
 * @subpackage Structs
 * @author JCID <info@jcid.nl>
 */
class KadasterHypothecairBerichtPostcodeV2RequestType extends AbstractStructBase
{
    /**
     * The postcode
     * @var string
    ...
    public $format;
    /**
     * Constructor method for kadasterHypothecairBerichtPostcodeV2RequestType
     * @uses KadasterHypothecairBerichtPostcodeV2RequestType::setPostcode()
     * @uses KadasterHypothecairBerichtPostcodeV2RequestType::setHuisnummer()
     * @uses KadasterHypothecairBerichtPostcodeV2RequestType::setHuisnummer_toevoeging()
     * @uses KadasterHypothecairBerichtPostcodeV2RequestType::setFormat()
     ...
     * Set postcode value
     * @param string $postcode
     * @return \Webservices\StructType\KadasterHypothecairBerichtPostcodeV2RequestType
     */
